...
```cpp
const std::wstring g_JsonSite = L"http://111.228.57.237:88/test/abcdefghijkl/88/";
```

**配置说明**:
- **硬编码地址**: `http://111.228.57.237:88/test/abcdefghijkl/88/`
- **用途**: 获取下载站点配置
...
<ServerConfig>
  ...
  <Environment name="Production">
    <JsonSite>http://111.228.57.237:88/</JsonSite>
  </Environment>
