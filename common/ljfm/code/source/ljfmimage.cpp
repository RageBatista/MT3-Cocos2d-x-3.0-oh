...
#endif
#ifdef _OS_ANDROID
	static inline LONG LJFMAtomicIncrement(volatile LONG* value)
	{
		return __sync_add_and_fetch(value, 1);
	}

	static inline LONG LJFMAtomicDecrement(volatile LONG* value)
	{
		return __sync_sub_and_fetch(value, 1);
	}

	static inline LONG LJFMAtomicRead(volatile LONG* value)
	{
	...
	namespace LJFMHLP
	{
		...
		public:
			...
			LONG Release()
			{
				...
				if (LONG lResult = LJFMAtomicDecrement(&m_refcount))
#elif defined(_OS_IOS)
...
#elif defined(_OS_ANDROID)
				return LJFMAtomicIncrement(&m_refcount);
#elif defined(_OS_IOS)
...
#elif defined(_OS_ANDROID)
				return LJFMAtomicRead((volatile LONG*)&m_refcount);
#elif defined(_OS_IOS)
...
#elif defined(_OS_ANDROID)
		return LJFMAtomicIncrement(&m_counter);
#elif defined(_OS_IOS)
...
#elif defined(_OS_ANDROID)
		if (LONG lResult = LJFMAtomicDecrement(&m_counter))
#elif defined(_OS_IOS)
