...
extern "C"
{
    ...
    void setEffectVolumeJNI(unsigned int nSoundId, float fVolume)
    {
        ...
        methodInfo.env->CallStaticVoidMethod(methodInfo.classID, methodInfo.methodID, (int)nSoundId, fVolume);
        methodInfo.env->DeleteLocalRef(methodInfo.classID);
    }
    ...
    bool hasEffectJNI(unsigned int nSoundId)
    {
        ...
        bool ret = methodInfo.env->CallStaticBooleanMethod(methodInfo.classID, methodInfo.methodID, (int)nSoundId);
        methodInfo.env->DeleteLocalRef(methodInfo.classID);
