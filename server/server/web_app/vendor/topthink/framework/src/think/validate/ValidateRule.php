...
class ValidateRule
{
     ...
     * @return $this
     */
    protected function addsuperItem(string $name, $rule = null, string $msg = '')
    {
        if ($rule || 0 === $rule) {
            $this->rule[$name] = $rule;
        } else {
    ...
    public function __call($method, $args)
    {
        ...
        return call_user_func_array([$this, 'addsuperItem'], $args);
    }
    ...
    public static function __callStatic($method, $args)
    {
        ...
        return call_user_func_array([$rule, 'addsuperItem'], $args);
    }
}
