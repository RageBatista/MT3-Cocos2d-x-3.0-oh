...
window.lyearSearchState = window.lyearSearchState || {
    apply: function (defaults, formSelector) {
        if (typeof URLSearchParams === 'undefined') {
            return;
        }

        var params = new URLSearchParams(window.location.search);
        var selector = formSelector || '.search-form';

        Object.keys(defaults || {}).forEach(function (key) {
            var $field = $(selector).find('[name="' + key + '"]');
            if (!$field.length) {
                return;
            }
    ...
    sync: function (values, defaults) {
        ...
        Object.keys(values || {}).forEach(function (key) {
            ...
            var defaultValue = defaults && Object.prototype.hasOwnProperty.call(defaults, key)
                ? defaults[key]
                : '';
