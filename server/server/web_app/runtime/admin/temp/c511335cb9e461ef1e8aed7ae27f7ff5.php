...
<head>
	...
	<!--tags插件css-->
	<link rel="stylesheet" type="text/css" href="/static/template/js/jquery-tagsinput/jquery.tagsinput.min.css">
	<link rel="stylesheet" type="text/css" href="/static/template/css/style.min.css">
	<!-- 加载 Select2 -->
	<script src="/static/template/select/jquery-3.2.1.min.js"></script>
	<link href="/static/template/select/select2.min.css" rel="stylesheet" />
	<script src="/static/template/select/select2.min.js"></script>
</head>
...
<body>
			...
			<div class="col-lg-12">
				<div class="card">
					<header class="card-header">
						<div class="card-title">GM工具</div>
					</header>
					<div class="card-body">

						<ul class="nav nav-tabs">
							<li class="nav-item">
								<a href="/index.php?s=/<?php echo htmlentities($app); ?>/gm/player/mod/basic" style="color:black">
									<button class="nav-link <?php if($mod=='basic'): ?>active<?php endif; ?>">基本操作</button>
								</a>
							</li>
							<li class="nav-item">
								<a href="/index.php?s=/<?php echo htmlentities($app); ?>/gm/player/mod/role" style="color:black">
									<button class="nav-link <?php if($mod=='role'): ?>active<?php endif; ?>">角色操作</button>
								</a>
							</li>
							<li class="nav-item">
								<a href="/index.php?s=/<?php echo htmlentities($app); ?>/gm/player/mod/pet" style="color:black">
									<button class="nav-link <?php if($mod=='pet'): ?>active<?php endif; ?>">宠物操作</button>
								</a>
							</li>
							<li class="nav-item">
								<a href="/index.php?s=/<?php echo htmlentities($app); ?>/gm/player/mod/gang" style="color:black">
									<button class="nav-link <?php if($mod=='gang'): ?>active<?php endif; ?>">帮派操作</button>
								</a>
							</li>
							<li class="nav-item">
								<a href="/index.php?s=/<?php echo htmlentities($app); ?>/gm/player/mod/equip" style="color:black">
									<button class="nav-link <?php if($mod=='equip'): ?>active<?php endif; ?>">装备定制</button>
								</a>
							</li>
						</ul>
						<form action="/index.php?s=/<?php echo htmlentities($app); ?>/gm/playerSub" method="post" class="edit-form">
							<input type="hidden" name="csrf_token" value="<?php echo htmlentities($csrf_token); ?>" />
							<div class="form-group">
								<label>角色ID</label>
								<input type="number" class="form-control" name="playerid"
									value="<?php if($playerid!=null): ?><?php echo htmlentities($playerid); ?><?php endif; ?>" placeholder="请输入玩家ID"
							...
							<div class="tab-content">
								<div class="form-group">
									<label>选择操作内容</label>
									<select name="gmcmd" class="form-control"
										style="width:100%;height:40px;border-radius:10px">
										...
										<option value="forgmbid">封禁账号</option>
										<option value="ungmforbid">解封账号</option>
										<option value="superforbiduser">全服封号</option>
										<option value="superunforbiduser">全服解封</option>
							...
							<?php endif; if($mod=='role'): ?>
							<div class="tab-content">
								<div class="form-group">
									<label>选择操作内容</label>
									<select name="gmcmd" class="form-control" onchange="setChange()"
										style="width:100%;height:40px;border-radius:10px">
										...
										<option value="addsuperitem">发送物品</option>
								...
								<script>
									function setChange() {
										...
										if (selectValue == 'changebindtel') {
											...
											$("#addtitle").hide();
											$("#rolecmd").hide();
										} else if (selectValue == 'addsuperitem') {
											$("#moblieNum").hide();
											$("#additem").show();
											$("#additem2").hide();
											$("#award").hide();
								...
								<div id="rolecmd" style="display:none">
									<div class="form-group col-md-12">
										<label>CMD命令</label>
										<input type="text" class="form-control" name="cmd" value=""
											placeholder="请输入CMD命令" style="width:100%;height:40px;border-radius:10px">
									</div>
								</div>
								<div id="moblieNum" style="display:none">
									<div class="form-group col-md-12">
										...
										<input type="number" class="form-control" name="mobile" value=""
											placeholder="请输入关联手机号码" style="width:100%;height:40px;border-radius:10px">
										<input type="text" class="form-control" value="此处填写关联手机号码"
											style="width:100%;height:40px;border-radius:10px;display:none" readonly>
									</div>
								</div>
								<div id="additem" style="display:none">
									<div class="form-group col-md-12">
										...
										<select name="itemid" id="itemid"
											style="width:100%;height:40px;border-radius:10px">
											<?php foreach($itemData as $value): ?>
											<option value="<?php echo htmlentities($value['itemid']); ?>"><?php echo htmlentities($value['name']); ?></option>
											<?php endforeach; ?>
										</select>
									</div>
									<br>
								...
								<div id="additem2" style="display:none">
									<div class="mb-3">
										...
										<input class="form-control" type="text" id="itemstr" name="itemstr" value=""
											readonly>
									...
									<div class="mb-3">
										...
										<div class="input-group">
											<input class="form-control" type="number" id="number2" value="1"
												placeholder="请输入物品数量">
										</div>
									</div>
								...
								<div id="award" style="display:none">
									<div class="form-group col-md-12">
										...
										<select name="awardid" id="awardid"
											style="width:100%;height:40px;border-radius:10px">
											<?php foreach($awardData as $value): ?>
											<option value="<?php echo htmlentities($value['itemid']); ?>"><?php echo htmlentities($value['name']); ?></option>
											<?php endforeach; ?>
										</select>
									</div>
								...
								<div id="num">
									<div class="form-group col-md-12">
										<label>数量</label>
										<input type="number" class="form-control" name="number" max="999999999" min="1"
											value="" placeholder="请输入发送数量"
											style="width:100%;height:40px;border-radius:10px">
									</div>
								</div>
								<div id="addtitle" style="display:none">
									<div class="form-group col-md-12">
										...
										<select name="titleid" id="titleid"
											style="width:100%;height:40px;border-radius:10px">
											<?php foreach($titleData as $value): ?>
											<option value="<?php echo htmlentities($value['itemid']); ?>"><?php echo htmlentities($value['name']); ?></option>
											<?php endforeach; ?>
										</select>
									</div>
							...
							<div id="addpet" style="display:none">
								...
								<div class="form-group col-md-12">
									<label>宠物等级</label>
									<input type="number" min='1' max='999' class="form-control" name="level"
										placeholder="请输入宠物等级" style="width:100%;height:40px;border-radius:10px" />
								</div>
							</div>
							<div id="petskill" style="display:none">
								<div class="form-group col-md-12">
									...
									<select name="skillid" id="skillid"
										style="width:100%;height:40px;border-radius:10px">
										<?php foreach($petSkillData as $value): ?>
										<option value="<?php echo htmlentities($value['itemid']); ?>"><?php echo htmlentities($value['name']); ?></option>
										<?php endforeach; ?>
									</select>
								</div>
							...
							<div id="number">
								<div class="form-group col-md-12">
									<label>数量</label>
									<input type="number" min='1' max='999999999' class="form-control" name="number"
										placeholder="请输入数量" style="width:100%;height:40px;border-radius:10px" />
								</div>
							</div>
							<br>
							<div class="mb-3">
							...
							<?php endif; if($mod=='equip'): ?>
							<div class="form-group">
								<div class="form-group col-md-12">
									<label>选择装备</label>
									<select id="equipid" name="equipid"
										style="width:100%;height:40px;border-radius:10px">
										<?php foreach($equip as $value): ?>
										<option value="<?php echo htmlentities($value['itemid']); ?>"><?php echo htmlentities($value['name']); ?></option>
										<?php endforeach; ?>
									</select>
								</div>
								<script>var selectorx = $('#equipid').select2({ placeholder: '请选择' });</script>
							</div>
							<div class="form-group col-md-12">
								<label>选择特技</label>
								<select id="skillid" name="skillid" style="width:100%;height:40px;border-radius:10px">
									<?php foreach($skilleffect as $value): ?>
									<option value="<?php echo htmlentities($value['itemid']); ?>"><?php echo htmlentities($value['name']); ?></option>
									<?php endforeach; ?>
								</select>
							</div>
							...
							<div class="form-group col-md-12">
								<label>选择特效</label>
								<select id="effectid" name="effectid" style="width:100%;height:40px;border-radius:10px">
									<?php foreach($skilleffect as $value): ?>
									<option value="<?php echo htmlentities($value['itemid']); ?>"><?php echo htmlentities($value['name']); ?></option>
									<?php endforeach; ?>
								</select>
							</div>
							<script>var selectorx = $('#effectid').select2({ placeholder: '请选择' });</script>


							<div class="form-group col-md-12">
								<label>套装ID</label>
								<div class="input-group col-md-12">
									<input type="number" class="form-control" name="suitid" placeholder="请输入套装ID"
										style="width:100%;height:40px;border-radius:10px">
								</div>
							</div>
							<div class="form-group col-md-12">
								<label>基础属性</label>
								<div class="input-group col-md-12">
									<input type="text" class="form-control" name="baseattr"
										placeholder="格式:属性=属性值,属性=属性值..."
										style="width:100%;height:40px;border-radius:10px">
								</div>
							</div>
							<div class="form-group col-md-12">
								<label>双加属性</label>
								<div class="input-group col-md-12">
									<input type="text" class="form-control" name="shuangjia"
										placeholder="格式:属性=属性值,属性=属性值..."
										style="width:100%;height:40px;border-radius:10px">
								</div>
							</div>
							<div class="form-group col-md-12">
								<label>熔炼属性</label>
								<div class="input-group col-md-12">
									<input type="text" class="form-control" name="ronglian"
										placeholder="格式:属性=属性值,属性=属性值..."
										style="width:100%;height:40px;border-radius:10px">
								</div>
							</div>
							...
							<div id="number">
								<div class="form-group col-md-12">
									<label>数量</label>
									<div class="input-group col-md-12">
										<input type="number" class="form-control" name="number" min="1" max="999999999"
											placeholder="请输入数量" style="width:100%;height:40px;border-radius:10px">
									</div>
								</div>
							</div>
	...
	<!--tags插件-->
	<script type="text/javascript" src="/static/template/js/jquery-tagsinput/jquery.tagsinput.min.js"></script>
