...
public class MonsterExtraAttrConfig  extends MonsterConfig {
	...
	public void checkValid(java.util.Map<String,java.util.Map<Integer,? extends Object> > objs){
			...
			do{
				int tmprefvalue=extraattrid1;
				
				if(tmprefvalue < 1) throw new RuntimeException("MonsterExtraAttrConfig.extraattrid1="+tmprefvalue+",所以不满足条件 MonsterExtraAttrConfig.extraattrid1 < 1");
			}while(false);
	}
	/**
	 * 
