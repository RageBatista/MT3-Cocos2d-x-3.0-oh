...
public class RefreshTimerNpc implements mytools.ConvMain.Checkable {
	...
	public RefreshTimerNpc(RefreshTimerNpc arg){
		...
		this.npcRandomType=arg.npcRandomType ;
		this.sceneList=arg.sceneList ;
		this.sceneCnt=arg.sceneCnt ;
		this.sceneRandomType=arg.sceneRandomType ;
	...
	public void checkValid(java.util.Map<String,java.util.Map<Integer,? extends Object> > objs){
			do{
				...
				if(tmprefvalue < 1) throw new RuntimeException("RefreshTimerNpc.id="+tmprefvalue+",所以不满足条件 RefreshTimerNpc.id < 1");
			}while(false);
	}
	/**
	 * 
	 ...
	 * 1 平均;  2 随机
	 */
	public int npcRandomType  = 0  ;
	
	public int getNpcRandomType(){
		return this.npcRandomType;
	}
	
	public void setNpcRandomType(int v){
		this.npcRandomType=v;
	}
	 ...
	 * 1 平均;  2 随机
	 */
	public int sceneRandomType  = 0  ;
	
	public int getSceneRandomType(){
		return this.sceneRandomType;
	}
	
	public void setSceneRandomType(int v){
		this.sceneRandomType=v;
	}
