...
public class CircTask implements mytools.ConvMain.Checkable ,Comparable<CircTask>{
	...
	public CircTask(CircTask arg){
		...
		this.extraitempropaward=arg.extraitempropaward ;
		this.extraitempropawardring=arg.extraitempropawardring ;
		this.mldbitempropaward=arg.mldbitempropaward ;
		this.mlgjitempropaward=arg.mlgjitempropaward ;
		...
		this.exproundlevelcoef=arg.exproundlevelcoef ;
		this.exproundfinal=arg.exproundfinal ;
		this.explevelcoef=arg.explevelcoef ;
		this.expfinal=arg.expfinal ;
		this.moneyroundlevelcoef=arg.moneyroundlevelcoef ;
		this.moneyroundcoef=arg.moneyroundcoef ;
		this.moneylevelcoef=arg.moneylevelcoef ;
		this.moneyroundfinal=arg.moneyroundfinal ;
		this.sroundlevelcoef=arg.sroundlevelcoef ;
		this.sroundcoef=arg.sroundcoef ;
		this.slevelcoef=arg.slevelcoef ;
		this.sroundfinal=arg.sroundfinal ;
		this.petexplevelcoef=arg.petexplevelcoef ;
		this.petexpfinal=arg.petexpfinal ;
		this.gjexpformula=arg.gjexpformula ;
		this.gjyinbiformula=arg.gjyinbiformula ;
		this.gjjinbiformula=arg.gjjinbiformula ;
		this.gjpetexpformula=arg.gjpetexpformula ;
		this.dbexpformula=arg.dbexpformula ;
		this.dbyinbiformula=arg.dbyinbiformula ;
		this.dbjinbiformula=arg.dbjinbiformula ;
		this.dbpetexpformula=arg.dbpetexpformula ;
		this.expformula=arg.expformula ;
		this.silvercoinformula=arg.silvercoinformula ;
		this.goldcoinformula=arg.goldcoinformula ;
		this.petexpformula=arg.petexpformula ;
		this.gaojiang60=arg.gaojiang60 ;
		this.gaojiang140=arg.gaojiang140 ;
	 ...
	 * 
	 */
	public int extraitempropaward  = 0  ;
	
	public int getExtraitempropaward(){
		return this.extraitempropaward;
	}
	
	public void setExtraitempropaward(int v){
		this.extraitempropaward=v;
	}
	
	/**
	 * 
	 */
	public int extraitempropawardring  = 0  ;
	
	public int getExtraitempropawardring(){
		return this.extraitempropawardring;
	}
	
	public void setExtraitempropawardring(int v){
		this.extraitempropawardring=v;
	}
	
	/**
	 * 
	 */
	public int mldbitempropaward  = 0  ;
	
	public int getMldbitempropaward(){
		return this.mldbitempropaward;
	}
	
	public void setMldbitempropaward(int v){
		this.mldbitempropaward=v;
	}
	
	/**
	 * 
	 */
	public int mlgjitempropaward  = 0  ;
	
	public int getMlgjitempropaward(){
		return this.mlgjitempropaward;
	}
	
	public void setMlgjitempropaward(int v){
		this.mlgjitempropaward=v;
	}
	 ...
	 * 
	 */
	public double exproundlevelcoef  = 0.0  ;
	
	public double getExproundlevelcoef(){
		return this.exproundlevelcoef;
	}
	
	public void setExproundlevelcoef(double v){
		this.exproundlevelcoef=v;
	}
	
	/**
	 * 
	 */
	public double exproundfinal  = 0.0  ;
	
	public double getExproundfinal(){
		return this.exproundfinal;
	}
	
	public void setExproundfinal(double v){
		this.exproundfinal=v;
	}
	
	/**
	 * 
	 */
	public double explevelcoef  = 0.0  ;
	
	public double getExplevelcoef(){
		return this.explevelcoef;
	}
	
	public void setExplevelcoef(double v){
		this.explevelcoef=v;
	}
	 ...
	 * 
	 */
	public double expfinal  = 0.0  ;
	
	public double getExpfinal(){
		return this.expfinal;
	}
	
	public void setExpfinal(double v){
		this.expfinal=v;
	}
	 ...
	 * 
	 */
	public double moneyroundlevelcoef  = 0.0  ;
	
	public double getMoneyroundlevelcoef(){
		return this.moneyroundlevelcoef;
	}
	
	public void setMoneyroundlevelcoef(double v){
		this.moneyroundlevelcoef=v;
	}
	
	/**
	 * 
	 */
	public double moneyroundcoef  = 0.0  ;
	
	public double getMoneyroundcoef(){
		return this.moneyroundcoef;
	}
	
	public void setMoneyroundcoef(double v){
		this.moneyroundcoef=v;
	}
	
	/**
	 * 
	 */
	public double moneylevelcoef  = 0.0  ;
	
	public double getMoneylevelcoef(){
		return this.moneylevelcoef;
	}
	
	public void setMoneylevelcoef(double v){
		this.moneylevelcoef=v;
	}
	
	/**
	 * 
	 */
	public double moneyroundfinal  = 0.0  ;
	
	public double getMoneyroundfinal(){
		return this.moneyroundfinal;
	}
	
	public void setMoneyroundfinal(double v){
		this.moneyroundfinal=v;
	}
	
	/**
	 * 
	 */
	public double sroundlevelcoef  = 0.0  ;
	
	public double getSroundlevelcoef(){
		return this.sroundlevelcoef;
	}
	
	public void setSroundlevelcoef(double v){
		this.sroundlevelcoef=v;
	}
	
	/**
	 * 
	 */
	public double sroundcoef  = 0.0  ;
	
	public double getSroundcoef(){
		return this.sroundcoef;
	}
	
	public void setSroundcoef(double v){
		this.sroundcoef=v;
	}
	 ...
	 * 
	 */
	public double slevelcoef  = 0.0  ;
	
	public double getSlevelcoef(){
		return this.slevelcoef;
	}
	
	public void setSlevelcoef(double v){
		this.slevelcoef=v;
	}
	 ...
	 * 
	 */
	public double sroundfinal  = 0.0  ;
	
	public double getSroundfinal(){
		return this.sroundfinal;
	}
	
	public void setSroundfinal(double v){
		this.sroundfinal=v;
	}
	 ...
	 * 
	 */
	public double petexplevelcoef  = 0.0  ;
	
	public double getPetexplevelcoef(){
		return this.petexplevelcoef;
	}
	
	public void setPetexplevelcoef(double v){
		this.petexplevelcoef=v;
	}
	
	/**
	 * 
	 */
	public double petexpfinal  = 0.0  ;
	
	public double getPetexpfinal(){
		return this.petexpfinal;
	}
	
	public void setPetexpfinal(double v){
		this.petexpfinal=v;
	}
	 ...
	 * 
	 */
	public String gjexpformula  = null  ;
	
	public String getGjexpformula(){
		return this.gjexpformula;
	}
	
	public void setGjexpformula(String v){
		this.gjexpformula=v;
	}
	 ...
	 * 
	 */
	public String gjyinbiformula  = null  ;
	
	public String getGjyinbiformula(){
		return this.gjyinbiformula;
	}
	
	public void setGjyinbiformula(String v){
		this.gjyinbiformula=v;
	}
	
	/**
	 * 
	 */
	public String gjjinbiformula  = null  ;
	
	public String getGjjinbiformula(){
		return this.gjjinbiformula;
	}
	
	public void setGjjinbiformula(String v){
		this.gjjinbiformula=v;
	}
	
	/**
	 * 
	 */
	public String gjpetexpformula  = null  ;
	
	public String getGjpetexpformula(){
		return this.gjpetexpformula;
	}
	
	public void setGjpetexpformula(String v){
		this.gjpetexpformula=v;
	}
	
	/**
	 * 
	 */
	public String dbexpformula  = null  ;
	
	public String getDbexpformula(){
		return this.dbexpformula;
	}
	
	public void setDbexpformula(String v){
		this.dbexpformula=v;
	}
	 ...
	 * 
	 */
	public String dbyinbiformula  = null  ;
	
	public String getDbyinbiformula(){
		return this.dbyinbiformula;
	}
	
	public void setDbyinbiformula(String v){
		this.dbyinbiformula=v;
	}
	
	/**
	 * 
	 */
	public String dbjinbiformula  = null  ;
	
	public String getDbjinbiformula(){
		return this.dbjinbiformula;
	}
	
	public void setDbjinbiformula(String v){
		this.dbjinbiformula=v;
	}
	
	/**
	 * 
	 */
	public String dbpetexpformula  = null  ;
	
	public String getDbpetexpformula(){
		return this.dbpetexpformula;
	}
	
	public void setDbpetexpformula(String v){
		this.dbpetexpformula=v;
	}
	
	/**
	 * 
	 */
	public String expformula  = null  ;
	
	public String getExpformula(){
		return this.expformula;
	}
	
	public void setExpformula(String v){
		this.expformula=v;
	}
	 ...
	 * 
	 */
	public String silvercoinformula  = null  ;
	
	public String getSilvercoinformula(){
		return this.silvercoinformula;
	}
	
	public void setSilvercoinformula(String v){
		this.silvercoinformula=v;
	}
	
	/**
	 * 
	 */
	public String goldcoinformula  = null  ;
	
	public String getGoldcoinformula(){
		return this.goldcoinformula;
	}
	
	public void setGoldcoinformula(String v){
		this.goldcoinformula=v;
	}
	
	/**
	 * 
	 */
	public String petexpformula  = null  ;
	
	public String getPetexpformula(){
		return this.petexpformula;
	}
	
	public void setPetexpformula(String v){
		this.petexpformula=v;
	}
	
	/**
	 * 
	 */
	public int gaojiang60  = 0  ;
	
	public int getGaojiang60(){
		return this.gaojiang60;
	}
	
	public void setGaojiang60(int v){
		this.gaojiang60=v;
	}
	 ...
	 * 
	 */
	public int gaojiang140  = 0  ;
	
	public int getGaojiang140(){
		return this.gaojiang140;
	}
	
	public void setGaojiang140(int v){
		this.gaojiang140=v;
	}
