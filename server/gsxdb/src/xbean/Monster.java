...
public interface Monster extends mkdb.Bean {
	public Monster copy(); // 深拷贝
	public Monster toData(); // 一个 Data 实例
	public Monster toBean(); // 一个 Bean 实例
	public Monster toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public Monster toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
	...
	public java.util.List<xbean.MonsterSkill> getSkills(); // 值=怪物技能
	public java.util.List<xbean.MonsterSkill> getSkillsAsData(); // 值=怪物技能
