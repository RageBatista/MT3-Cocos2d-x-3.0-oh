...
public interface InstanceZone extends mkdb.Bean {
	public InstanceZone copy(); // 深拷贝
	public InstanceZone toData(); // 一个 Data 实例
	public InstanceZone toBean(); // 一个 Bean 实例
	public InstanceZone toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public InstanceZone toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
