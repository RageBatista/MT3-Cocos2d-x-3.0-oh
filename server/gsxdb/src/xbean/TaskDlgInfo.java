...
public interface TaskDlgInfo extends mkdb.Bean {
	public TaskDlgInfo copy(); // 深拷贝
	public TaskDlgInfo toData(); // 一个 Data 实例
	public TaskDlgInfo toBean(); // 一个 Bean 实例
	public TaskDlgInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public TaskDlgInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
