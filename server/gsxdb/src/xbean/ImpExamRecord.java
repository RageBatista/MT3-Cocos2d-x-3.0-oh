...
public interface ImpExamRecord extends mkdb.Bean {
	public ImpExamRecord copy(); // 深拷贝
	public ImpExamRecord toData(); // 一个 Data 实例
	public ImpExamRecord toBean(); // 一个 Bean 实例
	public ImpExamRecord toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public ImpExamRecord toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
