...
public interface YbNum extends mkdb.Bean {
	public YbNum copy(); // 深拷贝
	public YbNum toData(); // 一个 Data 实例
	public YbNum toBean(); // 一个 Bean 实例
	public YbNum toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public YbNum toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
