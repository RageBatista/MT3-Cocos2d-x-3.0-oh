...
public interface AnYeTask extends mkdb.Bean {
	public AnYeTask copy(); // 深拷贝
	public AnYeTask toData(); // 一个 Data 实例
	public AnYeTask toBean(); // 一个 Bean 实例
	public AnYeTask toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public AnYeTask toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
