...
public interface ProgressBarInfo extends mkdb.Bean {
	public ProgressBarInfo copy(); // 深拷贝
	public ProgressBarInfo toData(); // 一个 Data 实例
	public ProgressBarInfo toBean(); // 一个 Bean 实例
	public ProgressBarInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public ProgressBarInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
