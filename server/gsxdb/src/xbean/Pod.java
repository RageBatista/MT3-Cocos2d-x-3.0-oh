...
public final class Pod {
	public static mkdb.util.BeanPool<DayCount> poolDayCount = new mkdb.util.BeanPool<DayCount>() {
		@Override
		protected DayCount newBean() {
			return new xbean.__.DayCount();
		}
	};

	public static DayCount newDayCount() {
		return poolDayCount.get();
	}

	public static void _reset_unsafe_add_(DayCount bean) {
		poolDayCount._reset_unsafe_add_(bean);
	}

	public static void padd(DayCount bean) {
		mkdb.Procedure.padd(bean, poolDayCount);
	}

	public static DayCount newDayCountData() {
		return new xbean.__.DayCount.Data();
	}

	public static mkdb.util.BeanPool<DayCounter> poolDayCounter = new mkdb.util.BeanPool<DayCounter>() {
		@Override
		protected DayCounter newBean() {
			return new xbean.__.DayCounter();
		}
	};

	public static DayCounter newDayCounter() {
		return poolDayCounter.get();
	}

	public static void _reset_unsafe_add_(DayCounter bean) {
		poolDayCounter._reset_unsafe_add_(bean);
	}

	public static void padd(DayCounter bean) {
		mkdb.Procedure.padd(bean, poolDayCounter);
	}

	public static DayCounter newDayCounterData() {
		return new xbean.__.DayCounter.Data();
	}
	...
	public static mkdb.util.BeanPool<TempTime> poolTempTime = new mkdb.util.BeanPool<TempTime>() {
		@Override
		protected TempTime newBean() {
			return new xbean.__.TempTime();
		}
	};

	public static TempTime newTempTime() {
		return poolTempTime.get();
	}

	public static void _reset_unsafe_add_(TempTime bean) {
		poolTempTime._reset_unsafe_add_(bean);
	}

	public static void padd(TempTime bean) {
		mkdb.Procedure.padd(bean, poolTempTime);
	}

	public static TempTime newTempTimeData() {
		return new xbean.__.TempTime.Data();
	}
	...
	public static mkdb.util.BeanPool<PotentialExtra> poolPotentialExtra = new mkdb.util.BeanPool<PotentialExtra>() {
		@Override
		protected PotentialExtra newBean() {
			return new xbean.__.PotentialExtra();
		}
	};

	public static PotentialExtra newPotentialExtra() {
		return poolPotentialExtra.get();
	}

	public static void _reset_unsafe_add_(PotentialExtra bean) {
		poolPotentialExtra._reset_unsafe_add_(bean);
	}

	public static void padd(PotentialExtra bean) {
		mkdb.Procedure.padd(bean, poolPotentialExtra);
	}

	public static PotentialExtra newPotentialExtraData() {
		return new xbean.__.PotentialExtra.Data();
	}
	...
	public static mkdb.util.BeanPool<PetEquipItem> poolPetEquipItem = new mkdb.util.BeanPool<PetEquipItem>() {
		@Override
		protected PetEquipItem newBean() {
			return new xbean.__.PetEquipItem();
		}
	};

	public static PetEquipItem newPetEquipItem() {
		return poolPetEquipItem.get();
	}

	public static void _reset_unsafe_add_(PetEquipItem bean) {
		poolPetEquipItem._reset_unsafe_add_(bean);
	}

	public static void padd(PetEquipItem bean) {
		mkdb.Procedure.padd(bean, poolPetEquipItem);
	}

	public static PetEquipItem newPetEquipItemData() {
		return new xbean.__.PetEquipItem.Data();
	}
	...
	public static mkdb.util.BeanPool<jiebaiAskInfo> pooljiebaiAskInfo = new mkdb.util.BeanPool<jiebaiAskInfo>() {
		@Override
		protected jiebaiAskInfo newBean() {
			return new xbean.__.jiebaiAskInfo();
		}
	};

	public static jiebaiAskInfo newjiebaiAskInfo() {
		return pooljiebaiAskInfo.get();
	}

	public static void _reset_unsafe_add_(jiebaiAskInfo bean) {
		pooljiebaiAskInfo._reset_unsafe_add_(bean);
	}

	public static void padd(jiebaiAskInfo bean) {
		mkdb.Procedure.padd(bean, pooljiebaiAskInfo);
	}

	public static jiebaiAskInfo newjiebaiAskInfoData() {
		return new xbean.__.jiebaiAskInfo.Data();
	}
	...
	public static mkdb.util.BeanPool<BitcoinNum> poolBitcoinNum = new mkdb.util.BeanPool<BitcoinNum>() {
		@Override
		protected BitcoinNum newBean() {
			return new xbean.__.BitcoinNum();
		}
	};

	public static BitcoinNum newBitcoinNum() {
		return poolBitcoinNum.get();
	}

	public static void _reset_unsafe_add_(BitcoinNum bean) {
		poolBitcoinNum._reset_unsafe_add_(bean);
	}

	public static void padd(BitcoinNum bean) {
		mkdb.Procedure.padd(bean, poolBitcoinNum);
	}

	public static BitcoinNum newBitcoinNumData() {
		return new xbean.__.BitcoinNum.Data();
	}

	public static mkdb.util.BeanPool<BitcoinNums> poolBitcoinNums = new mkdb.util.BeanPool<BitcoinNums>() {
		@Override
		protected BitcoinNums newBean() {
			return new xbean.__.BitcoinNums();
		}
	};

	public static BitcoinNums newBitcoinNums() {
		return poolBitcoinNums.get();
	}

	public static void _reset_unsafe_add_(BitcoinNums bean) {
		poolBitcoinNums._reset_unsafe_add_(bean);
	}

	public static void padd(BitcoinNums bean) {
		mkdb.Procedure.padd(bean, poolBitcoinNums);
	}

	public static BitcoinNums newBitcoinNumsData() {
		return new xbean.__.BitcoinNums.Data();
	}
	...
	public static mkdb.util.BeanPool<XingChenItem> poolXingChenItem = new mkdb.util.BeanPool<XingChenItem>() {
		@Override
		protected XingChenItem newBean() {
			return new xbean.__.XingChenItem();
		}
	};

	public static XingChenItem newXingChenItem() {
		return poolXingChenItem.get();
	}

	public static void _reset_unsafe_add_(XingChenItem bean) {
		poolXingChenItem._reset_unsafe_add_(bean);
	}

	public static void padd(XingChenItem bean) {
		mkdb.Procedure.padd(bean, poolXingChenItem);
	}

	public static XingChenItem newXingChenItemData() {
		return new xbean.__.XingChenItem.Data();
	}

	public static mkdb.util.BeanPool<Jingmai> poolJingmai = new mkdb.util.BeanPool<Jingmai>() {
		@Override
		protected Jingmai newBean() {
			return new xbean.__.Jingmai();
		}
	};

	public static Jingmai newJingmai() {
		return poolJingmai.get();
	}

	public static void _reset_unsafe_add_(Jingmai bean) {
		poolJingmai._reset_unsafe_add_(bean);
	}

	public static void padd(Jingmai bean) {
		mkdb.Procedure.padd(bean, poolJingmai);
	}

	public static Jingmai newJingmaiData() {
		return new xbean.__.Jingmai.Data();
	}
	...
	public static mkdb.util.BeanPool<TotalInfo> poolTotalInfo = new mkdb.util.BeanPool<TotalInfo>() {
		@Override
		protected TotalInfo newBean() {
			return new xbean.__.TotalInfo();
		}
	};

	public static TotalInfo newTotalInfo() {
		return poolTotalInfo.get();
	}

	public static void _reset_unsafe_add_(TotalInfo bean) {
		poolTotalInfo._reset_unsafe_add_(bean);
	}

	public static void padd(TotalInfo bean) {
		mkdb.Procedure.padd(bean, poolTotalInfo);
	}

	public static TotalInfo newTotalInfoData() {
		return new xbean.__.TotalInfo.Data();
	}

	public static mkdb.util.BeanPool<DailyInfo> poolDailyInfo = new mkdb.util.BeanPool<DailyInfo>() {
		@Override
	...
	public static void padd(DailyInfo bean) {
		mkdb.Procedure.padd(bean, poolDailyInfo);
	}
	...
	public static mkdb.util.BeanPool<TradingLock> poolTradingLock = new mkdb.util.BeanPool<TradingLock>() {
		@Override
		protected TradingLock newBean() {
			return new xbean.__.TradingLock();
		}
	};

	public static TradingLock newTradingLock() {
		return poolTradingLock.get();
	}

	public static void _reset_unsafe_add_(TradingLock bean) {
		poolTradingLock._reset_unsafe_add_(bean);
	}

	public static void padd(TradingLock bean) {
		mkdb.Procedure.padd(bean, poolTradingLock);
	}

	public static TradingLock newTradingLockData() {
		return new xbean.__.TradingLock.Data();
	}
	...
	public static mkdb.util.BeanPool<GuajiTaskState> poolGuajiTaskState = new mkdb.util.BeanPool<GuajiTaskState>() {
		@Override
		protected GuajiTaskState newBean() {
			return new xbean.__.GuajiTaskState();
		}
	};

	public static GuajiTaskState newGuajiTaskState() {
		return poolGuajiTaskState.get();
	}

	public static void _reset_unsafe_add_(GuajiTaskState bean) {
		poolGuajiTaskState._reset_unsafe_add_(bean);
	}

	public static void padd(GuajiTaskState bean) {
		mkdb.Procedure.padd(bean, poolGuajiTaskState);
	}

	public static GuajiTaskState newGuajiTaskStateData() {
		return new xbean.__.GuajiTaskState.Data();
	}
