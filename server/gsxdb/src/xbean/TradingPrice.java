...
public interface TradingPrice extends mkdb.Bean {
	public TradingPrice copy(); // 深拷贝
	public TradingPrice toData(); // 一个 Data 实例
	public TradingPrice toBean(); // 一个 Bean 实例
	public TradingPrice toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public TradingPrice toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
