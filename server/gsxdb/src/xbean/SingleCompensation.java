...
public interface SingleCompensation extends mkdb.Bean {
	public SingleCompensation copy(); // 深拷贝
	public SingleCompensation toData(); // 一个 Data 实例
	public SingleCompensation toBean(); // 一个 Bean 实例
	public SingleCompensation toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public SingleCompensation toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
	...
	public java.util.List<Long> getRoleids(); // 给定类型 == 0 结束
	public java.util.List<Long> getRoleidsAsData(); // 给定类型 == 0 结束
