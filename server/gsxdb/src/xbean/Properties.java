...
public interface Properties extends mkdb.Bean {
	public Properties copy(); // 深拷贝
	public Properties toData(); // 一个 Data 实例
	public Properties toBean(); // 一个 Bean 实例
	public Properties toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public Properties toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
