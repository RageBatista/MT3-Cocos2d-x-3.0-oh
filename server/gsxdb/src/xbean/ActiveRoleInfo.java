...
public interface ActiveRoleInfo extends mkdb.Bean {
	public ActiveRoleInfo copy(); // 深拷贝
	public ActiveRoleInfo toData(); // 一个 Data 实例
	public ActiveRoleInfo toBean(); // 一个 Bean 实例
	public ActiveRoleInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public ActiveRoleInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
