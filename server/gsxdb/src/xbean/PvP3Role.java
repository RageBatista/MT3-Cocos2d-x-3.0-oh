...
public interface PvP3Role extends mkdb.Bean {
	public PvP3Role copy(); // 深拷贝
	public PvP3Role toData(); // 一个 Data 实例
	public PvP3Role toBean(); // 一个 Bean 实例
	public PvP3Role toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public PvP3Role toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
