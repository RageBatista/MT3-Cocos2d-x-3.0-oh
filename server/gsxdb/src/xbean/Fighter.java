...
public interface Fighter extends mkdb.Bean {
	public Fighter copy(); // 深拷贝
	public Fighter toData(); // 一个 Data 实例
	public Fighter toBean(); // 一个 Bean 实例
	public Fighter toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public Fighter toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
