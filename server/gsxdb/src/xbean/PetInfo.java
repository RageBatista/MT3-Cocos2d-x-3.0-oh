...
public interface PetInfo extends mkdb.Bean {
	public PetInfo copy(); // 深拷贝
	public PetInfo toData(); // 一个 Data 实例
	public PetInfo toBean(); // 一个 Bean 实例
	public PetInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public PetInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
