...
public interface PvP1RaceRole extends mkdb.Bean {
	public PvP1RaceRole copy(); // 深拷贝
	public PvP1RaceRole toData(); // 一个 Data 实例
	public PvP1RaceRole toBean(); // 一个 Bean 实例
	public PvP1RaceRole toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public PvP1RaceRole toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
