...
public interface eventNpcInfo extends mkdb.Bean {
	public eventNpcInfo copy(); // 深拷贝
	public eventNpcInfo toData(); // 一个 Data 实例
	public eventNpcInfo toBean(); // 一个 Bean 实例
	public eventNpcInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public eventNpcInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
