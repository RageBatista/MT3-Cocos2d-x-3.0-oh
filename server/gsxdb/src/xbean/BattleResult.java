...
public interface BattleResult extends mkdb.Bean {
	public BattleResult copy(); // 深拷贝
	public BattleResult toData(); // 一个 Data 实例
	public BattleResult toBean(); // 一个 Bean 实例
	public BattleResult toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public BattleResult toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
