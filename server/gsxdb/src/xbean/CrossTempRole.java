...
public interface CrossTempRole extends mkdb.Bean {
	public CrossTempRole copy(); // 深拷贝
	public CrossTempRole toData(); // 一个 Data 实例
	public CrossTempRole toBean(); // 一个 Bean 实例
	public CrossTempRole toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public CrossTempRole toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
