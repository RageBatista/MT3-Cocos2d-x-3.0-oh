...
public interface RoleZongheRankRecord extends mkdb.Bean {
	public RoleZongheRankRecord copy(); // 深拷贝
	public RoleZongheRankRecord toData(); // 一个 Data 实例
	public RoleZongheRankRecord toBean(); // 一个 Bean 实例
	public RoleZongheRankRecord toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public RoleZongheRankRecord toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
