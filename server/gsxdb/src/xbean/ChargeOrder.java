...
public interface ChargeOrder extends mkdb.Bean {
	public ChargeOrder copy(); // 深拷贝
	public ChargeOrder toData(); // 一个 Data 实例
	public ChargeOrder toBean(); // 一个 Bean 实例
	public ChargeOrder toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public ChargeOrder toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
