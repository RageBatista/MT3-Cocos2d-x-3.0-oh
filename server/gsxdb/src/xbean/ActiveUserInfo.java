...
public interface ActiveUserInfo extends mkdb.Bean {
	public ActiveUserInfo copy(); // 深拷贝
	public ActiveUserInfo toData(); // 一个 Data 实例
	public ActiveUserInfo toBean(); // 一个 Bean 实例
	public ActiveUserInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public ActiveUserInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
