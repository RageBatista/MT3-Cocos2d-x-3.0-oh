...
public interface BattleInfo extends mkdb.Bean {
	public BattleInfo copy(); // 深拷贝
	public BattleInfo toData(); // 一个 Data 实例
	public BattleInfo toBean(); // 一个 Bean 实例
	public BattleInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public BattleInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
