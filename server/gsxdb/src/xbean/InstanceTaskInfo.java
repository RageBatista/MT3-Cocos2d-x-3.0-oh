...
public interface InstanceTaskInfo extends mkdb.Bean {
	public InstanceTaskInfo copy(); // 深拷贝
	public InstanceTaskInfo toData(); // 一个 Data 实例
	public InstanceTaskInfo toBean(); // 一个 Bean 实例
	public InstanceTaskInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public InstanceTaskInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
