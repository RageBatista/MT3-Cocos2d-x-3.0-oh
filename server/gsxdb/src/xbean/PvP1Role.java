...
public interface PvP1Role extends mkdb.Bean {
	public PvP1Role copy(); // 深拷贝
	public PvP1Role toData(); // 一个 Data 实例
	public PvP1Role toBean(); // 一个 Bean 实例
	public PvP1Role toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public PvP1Role toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
