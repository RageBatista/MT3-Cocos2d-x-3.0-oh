...
public interface PvP5Role extends mkdb.Bean {
	public PvP5Role copy(); // 深拷贝
	public PvP5Role toData(); // 一个 Data 实例
	public PvP5Role toBean(); // 一个 Bean 实例
	public PvP5Role toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public PvP5Role toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
