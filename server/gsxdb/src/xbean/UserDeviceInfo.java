...
public interface UserDeviceInfo extends mkdb.Bean {
	public UserDeviceInfo copy(); // 深拷贝
	public UserDeviceInfo toData(); // 一个 Data 实例
	public UserDeviceInfo toBean(); // 一个 Bean 实例
	public UserDeviceInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public UserDeviceInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
