...
public interface ClanInfo extends mkdb.Bean {
	public ClanInfo copy(); // 深拷贝
	public ClanInfo toData(); // 一个 Data 实例
	public ClanInfo toBean(); // 一个 Bean 实例
	public ClanInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public ClanInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
