...
public interface timerNpcInfo extends mkdb.Bean {
	public timerNpcInfo copy(); // 深拷贝
	public timerNpcInfo toData(); // 一个 Data 实例
	public timerNpcInfo toBean(); // 一个 Bean 实例
	public timerNpcInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public timerNpcInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
