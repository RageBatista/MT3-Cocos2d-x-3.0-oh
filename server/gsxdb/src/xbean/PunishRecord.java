...
public interface PunishRecord extends mkdb.Bean {
	public PunishRecord copy(); // 深拷贝
	public PunishRecord toData(); // 一个 Data 实例
	public PunishRecord toBean(); // 一个 Bean 实例
	public PunishRecord toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public PunishRecord toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
