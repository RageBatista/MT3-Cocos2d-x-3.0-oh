...
public interface PetItem extends mkdb.Bean {
	public PetItem copy(); // 深拷贝
	public PetItem toData(); // 一个 Data 实例
	public PetItem toBean(); // 一个 Bean 实例
	public PetItem toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public PetItem toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
