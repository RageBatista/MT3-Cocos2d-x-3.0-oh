...
public interface TeamInfo extends mkdb.Bean {
	public TeamInfo copy(); // 深拷贝
	public TeamInfo toData(); // 一个 Data 实例
	public TeamInfo toBean(); // 一个 Bean 实例
	public TeamInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public TeamInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
	...
	public java.util.Map<Long, Long> getInvitingids(); // 被邀请者的IDs 和时间 map，作者 changhao
	public java.util.Map<Long, Long> getInvitingidsAsData(); // 被邀请者的IDs 和时间 map，作者 changhao
