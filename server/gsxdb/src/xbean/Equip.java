...
public interface Equip extends mkdb.Bean {
	public Equip copy(); // 深拷贝
	public Equip toData(); // 一个 Data 实例
	public Equip toBean(); // 一个 Bean 实例
	public Equip toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public Equip toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
