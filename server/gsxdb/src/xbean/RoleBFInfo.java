...
public interface RoleBFInfo extends mkdb.Bean {
	public RoleBFInfo copy(); // 深拷贝
	public RoleBFInfo toData(); // 一个 Data 实例
	public RoleBFInfo toBean(); // 一个 Bean 实例
	public RoleBFInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public RoleBFInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
