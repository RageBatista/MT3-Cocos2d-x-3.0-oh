...
public interface InstanceInfo extends mkdb.Bean {
	public InstanceInfo copy(); // 深拷贝
	public InstanceInfo toData(); // 一个 Data 实例
	public InstanceInfo toBean(); // 一个 Bean 实例
	public InstanceInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public InstanceInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
