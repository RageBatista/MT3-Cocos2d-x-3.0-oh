...
public interface FailedMonster extends mkdb.Bean {
	public FailedMonster copy(); // 深拷贝
	public FailedMonster toData(); // 一个 Data 实例
	public FailedMonster toBean(); // 一个 Bean 实例
	public FailedMonster toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public FailedMonster toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
