...
public interface WheelInfo extends mkdb.Bean {
	public WheelInfo copy(); // 深拷贝
	public WheelInfo toData(); // 一个 Data 实例
	public WheelInfo toBean(); // 一个 Bean 实例
	public WheelInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public WheelInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
