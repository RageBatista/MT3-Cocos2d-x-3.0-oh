...
public interface YingYongBao extends mkdb.Bean {
	public YingYongBao copy(); // 深拷贝
	public YingYongBao toData(); // 一个 Data 实例
	public YingYongBao toBean(); // 一个 Bean 实例
	public YingYongBao toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public YingYongBao toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
