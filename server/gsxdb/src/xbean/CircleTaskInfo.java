...
public interface CircleTaskInfo extends mkdb.Bean {
	public CircleTaskInfo copy(); // 深拷贝
	public CircleTaskInfo toData(); // 一个 Data 实例
	public CircleTaskInfo toBean(); // 一个 Bean 实例
	public CircleTaskInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
