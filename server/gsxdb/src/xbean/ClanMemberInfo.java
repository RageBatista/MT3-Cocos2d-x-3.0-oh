...
public interface ClanMemberInfo extends mkdb.Bean {
	public ClanMemberInfo copy(); // 深拷贝
	public ClanMemberInfo toData(); // 一个 Data 实例
	public ClanMemberInfo toBean(); // 一个 Bean 实例
	public ClanMemberInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public ClanMemberInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
