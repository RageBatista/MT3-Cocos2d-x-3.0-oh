...
public interface ShowInfoBean extends mkdb.Bean {
	public ShowInfoBean copy(); // 深拷贝
	public ShowInfoBean toData(); // 一个 Data 实例
	public ShowInfoBean toBean(); // 一个 Bean 实例
	public ShowInfoBean toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public ShowInfoBean toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
