...
public interface RedPackInfo extends mkdb.Bean {
	public RedPackInfo copy(); // 深拷贝
	public RedPackInfo toData(); // 一个 Data 实例
	public RedPackInfo toBean(); // 一个 Bean 实例
	public RedPackInfo toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public RedPackInfo toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
