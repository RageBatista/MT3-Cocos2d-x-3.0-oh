...
public interface MenstorAndApprent extends mkdb.Bean {
	public MenstorAndApprent copy(); // 深拷贝
	public MenstorAndApprent toData(); // 一个 Data 实例
	public MenstorAndApprent toBean(); // 一个 Bean 实例
	public MenstorAndApprent toDataIf(); // 如果需要则返回一个 Data 实例，否则返回 this
	public MenstorAndApprent toBeanIf(); // 如果需要则返回一个 Bean 实例，否则返回 this
