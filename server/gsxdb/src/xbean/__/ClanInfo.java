...
public final class ClanInfo extends mkdb.XBean implements xbean.ClanInfo {
	...
	private int clanlevelmax; // 公会增加到达的最大等级，作者 changhao
	...
	private int money; // 公会资金，作者 changhao
	private java.util.HashMap<Integer, Integer> house; // 2金库3药房4旅馆  对应等级，作者 changhao
	private int bonus; // 公会分红，作者 changhao
	private int autostate; // 公会自动接收申请人入会的状态：0关闭 1开启
	private int totalscore; // 公会总评分，作者 changhao
	...
	@Override
	public int getClanlevelmax() { // 公会增加到达的最大等级，作者 changhao
		_xdb_verify_unsafe_();
		return clanlevelmax;
	}
	...
	@Override
	public int getMoney() { // 公会资金，作者 changhao
		_xdb_verify_unsafe_();
		return money;
	}

	@Override
	public java.util.Map<Integer, Integer> getHouse() { // 2金库3药房4旅馆  对应等级，作者 changhao
		_xdb_verify_unsafe_();
		return mkdb.Logs.logMap(new mkdb.LogKey(this, "house"), house);
	}

	@Override
	public java.util.Map<Integer, Integer> getHouseAsData() { // 2金库3药房4旅馆  对应等级，作者 changhao
		_xdb_verify_unsafe_();
	...
	@Override
	public int getBonus() { // 公会分红，作者 changhao
		_xdb_verify_unsafe_();
		return bonus;
	}
	...
	@Override
	public int getTotalscore() { // 公会总评分，作者 changhao
		_xdb_verify_unsafe_();
		return totalscore;
	}
	...
	@Override
	public void setClanlevelmax(int _v_) { // 公会增加到达的最大等级，作者 changhao
		_xdb_verify_unsafe_();
	...
	@Override
	public void setMoney(int _v_) { // 公会资金，作者 changhao
		_xdb_verify_unsafe_();
	...
	@Override
	public void setBonus(int _v_) { // 公会分红，作者 changhao
		_xdb_verify_unsafe_();
	...
	@Override
	public void setTotalscore(int _v_) { // 公会总评分，作者 changhao
		_xdb_verify_unsafe_();
