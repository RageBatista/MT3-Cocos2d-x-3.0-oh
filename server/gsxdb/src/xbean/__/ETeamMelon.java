...
public final class ETeamMelon extends mkdb.XBean implements xbean.ETeamMelon {
	private java.util.HashMap<Long, xbean.TeamMelon> melonid2melons; // 队伍分赃链表，作者 changhao
	...
	private java.util.LinkedList<Long> melonerlist; // 有资格分赃的原始人员，作者 changhao
	private java.util.LinkedList<Long> watchmelonerlist; // 没资格观看人员，作者 changhao
