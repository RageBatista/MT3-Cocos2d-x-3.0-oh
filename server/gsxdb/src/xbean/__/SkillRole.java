...
public final class SkillRole extends mkdb.XBean implements xbean.SkillRole {
	...
	private java.util.HashMap<Integer, xbean.PracticeSkill> practiceskill; // 修炼技能，作者 changhao
	private java.util.HashMap<Integer, xbean.LiveSkill> liveskill; // 生活技能，作者 changhao
