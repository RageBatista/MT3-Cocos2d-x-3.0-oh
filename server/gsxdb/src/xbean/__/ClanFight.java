...
public final class ClanFight extends mkdb.XBean implements xbean.ClanFight {
	private long clan1; // 第一个公会，作者 changhao
	private int clanindex1; // 第一个公会，作者 changhao
	private String clanname1; // 第一个公会名字，作者 changhao
	private long clan2; // 第二个公会，作者 changhao
	private int clanindex2; // 第二个公会，作者 changhao
	private String clanname2; // 第二个公会名字，作者 changhao
	private int clanlevel1; // 第一个公会等级，作者 changhao
	private int clanlevel2; // 第二个公会等级，作者 changhao
	private int clan1scroe; // clan1积分，作者 changhao
	private int clan2scroe; // clan2积分，作者 changhao
	private int winner; // 胜利者(-1是还没结果0是第一个公会赢1是第2个公会赢)，作者 changhao
	...
	@Override
	public long getClan1() { // 第一个公会，作者 changhao
		_xdb_verify_unsafe_();
		return clan1;
	}

	@Override
	public int getClanindex1() { // 第一个公会，作者 changhao
		_xdb_verify_unsafe_();
		return clanindex1;
	}

	@Override
	public String getClanname1() { // 第一个公会名字，作者 changhao
		_xdb_verify_unsafe_();
		return clanname1;
	}

	@Override
	public com.locojoy.base.Octets getClanname1Octets() { // 第一个公会名字，作者 changhao
		_xdb_verify_unsafe_();
		return com.locojoy.base.Octets.wrap(getClanname1(), mkdb.Const.IO_CHARSET);
	}

	@Override
	public long getClan2() { // 第二个公会，作者 changhao
		_xdb_verify_unsafe_();
		return clan2;
	}

	@Override
	public int getClanindex2() { // 第二个公会，作者 changhao
		_xdb_verify_unsafe_();
		return clanindex2;
	}

	@Override
	public String getClanname2() { // 第二个公会名字，作者 changhao
		_xdb_verify_unsafe_();
		return clanname2;
	}

	@Override
	public com.locojoy.base.Octets getClanname2Octets() { // 第二个公会名字，作者 changhao
		_xdb_verify_unsafe_();
		return com.locojoy.base.Octets.wrap(getClanname2(), mkdb.Const.IO_CHARSET);
	}

	@Override
	public int getClanlevel1() { // 第一个公会等级，作者 changhao
		_xdb_verify_unsafe_();
		return clanlevel1;
	}

	@Override
	public int getClanlevel2() { // 第二个公会等级，作者 changhao
		_xdb_verify_unsafe_();
		return clanlevel2;
	}

	@Override
	public int getClan1scroe() { // clan1积分，作者 changhao
		_xdb_verify_unsafe_();
		return clan1scroe;
	}

	@Override
	public int getClan2scroe() { // clan2积分，作者 changhao
		_xdb_verify_unsafe_();
		return clan2scroe;
	}

	@Override
	public int getWinner() { // 胜利者(-1是还没结果0是第一个公会赢1是第2个公会赢)，作者 changhao
		_xdb_verify_unsafe_();
		return winner;
	}

	@Override
	public void setClan1(long _v_) { // 第一个公会，作者 changhao
		_xdb_verify_unsafe_();
	...
	@Override
	public void setClanindex1(int _v_) { // 第一个公会，作者 changhao
		_xdb_verify_unsafe_();
	...
	@Override
	public void setClanname1(String _v_) { // 第一个公会名字，作者 changhao
		_xdb_verify_unsafe_();
		if (null == _v_)
	...
	@Override
	public void setClanname1Octets(com.locojoy.base.Octets _v_) { // 第一个公会名字，作者 changhao
		_xdb_verify_unsafe_();
		this.setClanname1(_v_.getString(mkdb.Const.IO_CHARSET));
	}

	@Override
	public void setClan2(long _v_) { // 第二个公会，作者 changhao
		_xdb_verify_unsafe_();
	...
	@Override
	public void setClanindex2(int _v_) { // 第二个公会，作者 changhao
		_xdb_verify_unsafe_();
	...
	@Override
	public void setClanname2(String _v_) { // 第二个公会名字，作者 changhao
		_xdb_verify_unsafe_();
		if (null == _v_)
			throw new NullPointerException();
	...
	@Override
	public void setClanname2Octets(com.locojoy.base.Octets _v_) { // 第二个公会名字，作者 changhao
		_xdb_verify_unsafe_();
		this.setClanname2(_v_.getString(mkdb.Const.IO_CHARSET));
	}

	@Override
	public void setClanlevel1(int _v_) { // 第一个公会等级，作者 changhao
		_xdb_verify_unsafe_();
	...
	@Override
	public void setClanlevel2(int _v_) { // 第二个公会等级，作者 changhao
		_xdb_verify_unsafe_();
	...
	@Override
	public void setClan1scroe(int _v_) { // clan1积分，作者 changhao
		_xdb_verify_unsafe_();
	...
	@Override
	public void setClan2scroe(int _v_) { // clan2积分，作者 changhao
		_xdb_verify_unsafe_();
	...
	@Override
	public void setWinner(int _v_) { // 胜利者(-1是还没结果0是第一个公会赢1是第2个公会赢)，作者 changhao
		_xdb_verify_unsafe_();
