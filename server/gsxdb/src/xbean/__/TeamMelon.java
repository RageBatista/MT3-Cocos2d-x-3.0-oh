...
public final class TeamMelon extends mkdb.XBean implements xbean.TeamMelon {
	private int itemid; // 道具表id，作者 changhao
	private int itemnum; // 道具数量，作者 changha
	private xbean.Item itemdata; // 道具数据，作者 changhao
	private int awardid; // 奖励表id
	private java.util.HashMap<Long, Integer> melonroleids; // 分赃人员(roll点决定)，作者 changhao
	private java.util.HashMap<Long, Integer> opmelonroleids; // 已经操作的分赃人员，作者 changhao
	private int maxrollpoint; // 最大ROLL点，作者 changhao
	private int opnum; // 已经ROLL点的人员数量，作者 changhao
	private long battleid; // 战斗ID，作者 changhao
	private int battleresult; // 战斗结果，作者 changhao
