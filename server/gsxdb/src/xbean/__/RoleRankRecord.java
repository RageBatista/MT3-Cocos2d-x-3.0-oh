...
public final class RoleRankRecord extends mkdb.XBean implements xbean.RoleRankRecord {
	...
	private long roleid; // 人物ID，作者 changhao
	private String rolename; // 人物名称，作者 changhao
	private int school; // 职业，作者 changhao
	private int level; // 等级，作者 changhao
	private int score; // 人物评分，作者 changhao
	...
	private class Const implements xbean.RoleRankRecord {
		...
		public java.util.Map<Integer, Integer> getComponentsAsData() { // 装备部件
			_xdb_verify_unsafe_();
			java.util.Map<Integer, Integer> components;
			RoleRankRecord _o_ = RoleRankRecord.this;
			components = new java.util.HashMap<Integer, Integer>();
			for (java.util.Map.Entry<Integer, Integer> _e_ : _o_.components.entrySet())
				components.put(_e_.getKey(), _e_.getValue());
			return components;
