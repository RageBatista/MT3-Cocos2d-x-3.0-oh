...
public final class ActivityQuestion extends mkdb.XBean implements xbean.ActivityQuestion {
	private long activityquestionstarttime; // 活动答题开启时间，作者 changhao
	private java.util.LinkedList<Integer> questionids; // 题目，作者 changhao
	private int curquestionindex; // 当前回答的问题，作者 changhao
	private int curquestionstep; // 当前回答的步骤，作者 changhao
	private int answerrighttimes; // 回答正确的次数，作者 changhao
	private int totalanswernum; // 总共回答的数量，作者 changhao
	private int grabreward; // 1是可以领取2是已经领取3是不能领取，作者 changhao
	private int totalexp; // 总经验，作者 changhao
	private int totalmoney; // 总金币，作者 changhao
	private int helptimes; // 帮助次数，作者 changhao
