...
public final class Equip extends mkdb.XBean implements xbean.Equip {
	...
	private int newskill; // 技能
	private int effect; // 特效
	private int neweffect; // 特效
	...
	private java.util.HashMap<Integer, Integer> extraattr; // 基础属性
	private java.util.HashMap<Integer, Integer> extraaddattr; // 附加属性
	private java.util.HashMap<Integer, xbean.EnhancementData> enhancement; // 附魔属性，作者 changhao
	private int equipscore; // 装备评分
	private int taozhuangeffectid; // 套装特效ID
	private java.util.LinkedList<Integer> diamonds; // 宝石列表
	private int equipsit; // 套装
	...
	Equip(int __, mkdb.XBean _xp_, String _vn_) {
		...
		extraattr = new java.util.HashMap<Integer, Integer>();
		extraaddattr = new java.util.HashMap<Integer, Integer>();
	...
	private void assign(Equip _o_) {
		...
		skill = _o_.skill;
		newskill = _o_.newskill;
		effect = _o_.effect;
		neweffect = _o_.neweffect;
		...
		extraattr = new java.util.HashMap<Integer, Integer>();
		for (java.util.Map.Entry<Integer, Integer> _e_ : _o_.extraattr.entrySet())
			extraattr.put(_e_.getKey(), _e_.getValue());
		extraaddattr = new java.util.HashMap<Integer, Integer>();
		for (java.util.Map.Entry<Integer, Integer> _e_ : _o_.extraaddattr.entrySet())
			extraaddattr.put(_e_.getKey(), _e_.getValue());
		enhancement = new java.util.HashMap<Integer, xbean.EnhancementData>();
		...
		taozhuangeffectid = _o_.taozhuangeffectid;
		diamonds = new java.util.LinkedList<Integer>();
		diamonds.addAll(_o_.diamonds);
		equipsit = _o_.equipsit;
	}
	...
	public final OctetsStream marshal(OctetsStream _os_) {
		...
		_os_.marshal(skill);
		_os_.marshal(newskill);
		_os_.marshal(effect);
		_os_.marshal(neweffect);
		...
		_os_.compact_uint32(extraattr.size());
		for (java.util.Map.Entry<Integer, Integer> _e_ : extraattr.entrySet())
		{
			_os_.marshal(_e_.getKey());
			_os_.marshal(_e_.getValue());
		}
		_os_.compact_uint32(extraaddattr.size());
		for (java.util.Map.Entry<Integer, Integer> _e_ : extraaddattr.entrySet())
		{
			_os_.marshal(_e_.getKey());
			_os_.marshal(_e_.getValue());
		}
	...
	public final OctetsStream unmarshal(OctetsStream _os_) throws MarshalException {
		...
		newskill = _os_.unmarshal_int();
		effect = _os_.unmarshal_int();
		neweffect = _os_.unmarshal_int();
		...
		}
		{
			int size = _os_.uncompact_uint32();
			if (size >= 12) { // {java.util.HashMap} 16 * 0.75 = 12
				extraattr = new java.util.HashMap<Integer, Integer>(size * 2);
			}
			for (; size > 0; --size)
			{
				int _k_ = 0;
				...
				int _v_ = 0;
				_v_ = _os_.unmarshal_int();
				extraattr.put(_k_, _v_);
			}
		}
		{
			int size = _os_.uncompact_uint32();
			if (size >= 12) { // {java.util.HashMap} 16 * 0.75 = 12
				extraaddattr = new java.util.HashMap<Integer, Integer>(size * 2);
			}
			for (; size > 0; --size)
			{
				int _k_ = 0;
		...
		taozhuangeffectid = _os_.unmarshal_int();
		for (int size = _os_.uncompact_uint32(); size > 0; --size) {
			int _v_ = 0;
			_v_ = _os_.unmarshal_int();
			diamonds.add(_v_);
		}
		equipsit = _os_.unmarshal_int();
		return _os_;
	}
	...
	public java.util.Map<Integer, Integer> getExtraattr() { // 基础属性
		_xdb_verify_unsafe_();
		return mkdb.Logs.logMap(new mkdb.LogKey(this, "extraattr"), extraattr);
	}

	@Override
	public java.util.Map<Integer, Integer> getExtraattrAsData() { // 基础属性
		_xdb_verify_unsafe_();
		java.util.Map<Integer, Integer> extraattr;
		Equip _o_ = this;
		extraattr = new java.util.HashMap<Integer, Integer>();
		for (java.util.Map.Entry<Integer, Integer> _e_ : _o_.extraattr.entrySet())
			extraattr.put(_e_.getKey(), _e_.getValue());
	...
	public java.util.Map<Integer, Integer> getExtraaddattr() { // 附加属性
		_xdb_verify_unsafe_();
		return mkdb.Logs.logMap(new mkdb.LogKey(this, "extraaddattr"), extraaddattr);
	}

	@Override
	public java.util.Map<Integer, Integer> getExtraaddattrAsData() { // 附加属性
		_xdb_verify_unsafe_();
		java.util.Map<Integer, Integer> extraaddattr;
		Equip _o_ = this;
		extraaddattr = new java.util.HashMap<Integer, Integer>();
		for (java.util.Map.Entry<Integer, Integer> _e_ : _o_.extraaddattr.entrySet())
			extraaddattr.put(_e_.getKey(), _e_.getValue());
	...
	@Override
	public java.util.Map<Integer, xbean.EnhancementData> getEnhancement() { // 附魔属性，作者 changhao
		_xdb_verify_unsafe_();
		return mkdb.Logs.logMap(new mkdb.LogKey(this, "enhancement"), enhancement);
	}

	@Override
	public java.util.Map<Integer, xbean.EnhancementData> getEnhancementAsData() { // 附魔属性，作者 changhao
		_xdb_verify_unsafe_();
	...
	@Override
	public int getTaozhuangeffectid() { // 套装特效ID
		_xdb_verify_unsafe_();
		return taozhuangeffectid;
	}
	...
	@Override
	public void setNewskill(int _v_) { // 技能
		_xdb_verify_unsafe_();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "newskill") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogInt(this, newskill) {
					public void rollback() { newskill = _xdb_saved; }
				};}});
		newskill = _v_;
	}
	...
	public void setNeweffect(int _v_) { // 特效
		_xdb_verify_unsafe_();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "neweffect") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogInt(this, neweffect) {
					public void rollback() { neweffect = _xdb_saved; }
				};}});
		neweffect = _v_;
	}
	...
	@Override
	public void setTaozhuangeffectid(int _v_) { // 套装特效ID
		_xdb_verify_unsafe_();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "taozhuangeffectid") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogInt(this, taozhuangeffectid) {
					public void rollback() { taozhuangeffectid = _xdb_saved; }
				};}});
		taozhuangeffectid = _v_;
	}

	@Override
	public void setEquipsit(int _v_) { // 套装
		_xdb_verify_unsafe_();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "equipsit") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogInt(this, equipsit) {
					public void rollback() { equipsit = _xdb_saved; }
				};}});
		equipsit = _v_;
	}
	...
	public final int hashCode() {
		...
		_h_ += extraattr.hashCode();
		_h_ += extraaddattr.hashCode();
		_h_ += enhancement.hashCode();
		_h_ += equipscore;
		_h_ += taozhuangeffectid;
	...
	public String toString() {
		...
		_sb_.append(skill);
		_sb_.append(",");
		_sb_.append(newskill);
		_sb_.append(",");
		_sb_.append(effect);
		_sb_.append(",");
		_sb_.append(neweffect);
		_sb_.append(",");
		...
		_sb_.append(addattr);
		_sb_.append(",");
		_sb_.append(extraattr);
		_sb_.append(",");
		_sb_.append(extraaddattr);
		_sb_.append(",");
		_sb_.append(enhancement);
		_sb_.append(",");
		_sb_.append(equipscore);
		_sb_.append(",");
		_sb_.append(taozhuangeffectid);
		_sb_.append(",");
		_sb_.append(diamonds);
		_sb_.append(",");
		_sb_.append(equipsit);
		_sb_.append(")");
	...
	public mkdb.logs.Listenable newListenable() {
		...
		lb.add(new mkdb.logs.ListenableChanged().setVarName("newskill"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("effect"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("neweffect"));
		...
		lb.add(new mkdb.logs.ListenableMap().setVarName("extraattr"));
		lb.add(new mkdb.logs.ListenableMap().setVarName("extraaddattr"));
		lb.add(new mkdb.logs.ListenableMap().setVarName("enhancement"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("equipscore"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("taozhuangeffectid"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("diamonds"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("equipsit"));
		return lb;
	}
	...
	private class Const implements xbean.Equip {
		...
		public java.util.Map<Integer, Integer> getExtraattr() { // 基础属性
			_xdb_verify_unsafe_();
			return mkdb.Consts.constMap(extraattr);
		}
		...
		public java.util.Map<Integer, Integer> getExtraaddattr() { // 附加属性
			_xdb_verify_unsafe_();
			return mkdb.Consts.constMap(extraaddattr);
		}
