...
public final class ClanProgressRankRecord extends mkdb.XBean implements xbean.ClanProgressRankRecord {
	private int rank; // 排名，作者 changhao
	private long clankey; // 
	private String clanname; // 公会名称，作者 changhao
	private long time; // 时间，作者 changhao
	private int progress; // 进度，作者 changhao
	private String clanmastername; // 会长名字，作者 changhao
	private long triggertime; // 触发时间，作者 changhao
	private int copyid; // 副本id，作者 changhao
	private String copyname; // 副本名字，作者 changhao
	private float bosshp; // BOSS血量，作者 changhao
