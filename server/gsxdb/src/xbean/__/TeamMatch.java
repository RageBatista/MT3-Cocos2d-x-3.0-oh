...
public final class TeamMatch extends mkdb.XBean implements xbean.TeamMatch {
	private long roleid; // 角色ID，作者 changhao
	private int matchtype; // 类型0是个人1是队伍，作者 changhao
	private int targetid; // 目标ID，作者 changhao
	private int levelmin; // 需要最小等级 个人匹配这个忽略，作者 changhao
	private int levelmax; // 需要最大等级 个人匹配这个忽略，作者 changhao
	private long onekeytimestamp; // 一键喊话时间戳，作者 changhao
	private long timestamp; // 匹配后的时间戳，作者 changhao
