...
public final class MarshalClanFightHistroyRankRecord extends mkdb.XBean implements xbean.MarshalClanFightHistroyRankRecord {
	private long clanid; // 公会id，作者 changhao
	private String clanname; // 公会名字，作者 changhao
	private int clanlevel; // 公会等级，作者 changhao
	private int fightcount; // 战斗次数，作者 changhao
	private int wincount; // 胜利次数，作者 changhao
	private int totalscroe; // 公会战积分，作者 changhao
