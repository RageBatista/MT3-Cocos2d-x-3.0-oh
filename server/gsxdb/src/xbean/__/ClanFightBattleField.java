...
public final class ClanFightBattleField extends mkdb.XBean implements xbean.ClanFightBattleField {
	private int battlefieldid; // excel表里的ID，作者 changhao
	private long clanfightid; // 公会战id，作者 changhao
	private int state; // 战场状态，作者 changhao
	private long clanid1; // 公会1，作者 changhao
	private long clanid2; // 公会2，作者 changhao
	private String clanname1; // 公会名字1，作者 changhao
	private String clanname2; // 公会名字2，作者 changhao
	private int clanscore1; // 公会1积分，作者 changhao
	private int clanscore2; // 公会2积分，作者 changhao
	private java.util.HashMap<Long, Integer> clan1roleids; // 进入公会战场的 公会1玩家，作者 changhao
	private java.util.HashMap<Long, Integer> clan2roleids; // 进入公会战场的 公会2玩家，作者 changhao
	private java.util.HashMap<Long, String> enterroleids; // 进入过战场的角色id，作者 changhao
	private java.util.HashMap<Long, Integer> clan1enterroleids; // 公会1战场进入过的玩家，作者 changhao
	private java.util.HashMap<Long, Integer> clan2enterroleids; // 公会2战场进入过的玩家，作者 changhao
	private java.util.LinkedList<xbean.BattleFieldScroeRank> clan1roleranklist; // 当前战场排名1，作者 changhao
	private java.util.LinkedList<xbean.BattleFieldScroeRank> clan2roleranklist; // 当前战场排名2，作者 changhao
	private java.util.HashMap<Long, Integer> clan1rolerankmap; // key是角色id value是排名(从0开始)，作者 changhao
	private java.util.HashMap<Long, Integer> clan2rolerankmap; // key是角色id value是排名(从0开始)，作者 changhao
	private long lastclan1rolesortstamp; // 上次排序时间戳，作者 changhao
	private long lastclan2rolesortstamp; // 上次排序时间戳，作者 changhao
	private java.util.LinkedList<Long> victoryboxids; // 胜利宝箱链表，作者 changhao
	private java.util.LinkedList<Long> celebrateboxids; // 庆祝宝箱链表，作者 changhao
	private long datetime; // 周几那场比赛时间，作者 changhao
	private long activitystarttime; // 公会战活动开始时间，作者 changhao
	private long activitypreparetime; // 公会战准备结束时间，作者 changhao
	private long activitynoentertime; // 公会战不能在进入时间，作者 changhao
	private long activityendtime; // 公会战活动结束时间，作者 changhao
	private int whichwin; // -1没结果0是第一个公会1是第二个公会，作者 changhao
