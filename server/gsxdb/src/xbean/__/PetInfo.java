...
public final class PetInfo extends mkdb.XBean implements xbean.PetInfo {
	...
	private java.util.HashMap<Integer, Float> effects; // key = 效果类型id
	private java.util.HashMap<Integer, Float> finalattrs; // key = 属性类型
	private xbean.BuffAgent buffpet; // 浅黄色
	...
	private java.util.LinkedList<xbean.PetSkill> internals; // 宠物拥有的战斗技能
	private java.util.LinkedList<xbean.PetEquipItem> petequipbag; // 宠物装备列表
	private int uselevel; // 参战等级
	private int petid; // 原始宠物id
	private int qianye; // 千叶值
	private int useqianyecount; // 使用千叶的次数
	private int pettaozhuang; // 宠物套装ID
	...
	PetInfo(int __, mkdb.XBean _xp_, String _vn_) {
		...
		shenshouinccount = 0;
		marketfreezeexpire = 0;
		internals = new java.util.LinkedList<xbean.PetSkill>();
		petequipbag = new java.util.LinkedList<xbean.PetEquipItem>();
		uselevel = 0;
		petid = 0;
		qianye = 0;
		useqianyecount = 0;
	...
	private void assign(PetInfo _o_) {
		...
		petequipbag = new java.util.LinkedList<xbean.PetEquipItem>();
		for (xbean.PetEquipItem _v_ : _o_.petequipbag)
			petequipbag.add(new PetEquipItem(_v_, this, "petequipbag"));
		uselevel = _o_.uselevel;
		petid = _o_.petid;
		qianye = _o_.qianye;
		useqianyecount = _o_.useqianyecount;
		pettaozhuang = _o_.pettaozhuang;
	}
	...
	public final OctetsStream marshal(OctetsStream _os_) {
		...
		_os_.compact_uint32(petequipbag.size());
		for (xbean.PetEquipItem _v_ : petequipbag) {
			_v_.marshal(_os_);
		}
		_os_.marshal(uselevel);
		_os_.marshal(petid);
		_os_.marshal(qianye);
		_os_.marshal(useqianyecount);
		_os_.marshal(pettaozhuang);
		return _os_;
	}
	...
	public final OctetsStream unmarshal(OctetsStream _os_) throws MarshalException {
		...
		for (int size = _os_.uncompact_uint32(); size > 0; --size) {
			xbean.PetEquipItem _v_ = new PetEquipItem(0, this, "petequipbag");
			_v_.unmarshal(_os_);
			petequipbag.add(_v_);
		}
		uselevel = _os_.unmarshal_int();
		petid = _os_.unmarshal_int();
		qianye = _os_.unmarshal_int();
		useqianyecount = _os_.unmarshal_int();
		pettaozhuang = _os_.unmarshal_int();
		return _os_;
	}
	...
	@Override
	public xbean.BuffAgent getBuffpet() { // 浅黄色
		_xdb_verify_unsafe_();
		return buffpet;
	}
	...
	@Override
	public java.util.List<xbean.PetSkill> getInternals() { // 宠物拥有的战斗技能
		_xdb_verify_unsafe_();
		return mkdb.Logs.logList(new mkdb.LogKey(this, "internals"), internals);
	}

	public java.util.List<xbean.PetSkill> getInternalsAsData() { // 宠物拥有的战斗技能
		_xdb_verify_unsafe_();
		java.util.List<xbean.PetSkill> internals;
		PetInfo _o_ = this;
		internals = new java.util.LinkedList<xbean.PetSkill>();
		for (xbean.PetSkill _v_ : _o_.internals)
	...
	@Override
	public java.util.List<xbean.PetEquipItem> getPetequipbag() { // 宠物装备列表
		_xdb_verify_unsafe_();
		return mkdb.Logs.logList(new mkdb.LogKey(this, "petequipbag"), petequipbag);
	}

	public java.util.List<xbean.PetEquipItem> getPetequipbagAsData() { // 宠物装备列表
		_xdb_verify_unsafe_();
		java.util.List<xbean.PetEquipItem> petequipbag;
		PetInfo _o_ = this;
		petequipbag = new java.util.LinkedList<xbean.PetEquipItem>();
		for (xbean.PetEquipItem _v_ : _o_.petequipbag)
			petequipbag.add(new PetEquipItem.Data(_v_));
		return petequipbag;
	}

	@Override
	public int getUselevel() { // 参战等级
		_xdb_verify_unsafe_();
		return uselevel;
	}

	@Override
	public int getPetid() { // 原始宠物id
		_xdb_verify_unsafe_();
		return petid;
	}

	@Override
	public int getQianye() { // 千叶值
		_xdb_verify_unsafe_();
		return qianye;
	}

	@Override
	public int getUseqianyecount() { // 使用千叶的次数
		_xdb_verify_unsafe_();
		return useqianyecount;
	}

	@Override
	public int getPettaozhuang() { // 宠物套装ID
		_xdb_verify_unsafe_();
		return pettaozhuang;
	}
	...
	@Override
	public void setUselevel(int _v_) { // 参战等级
		_xdb_verify_unsafe_();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "uselevel") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogInt(this, uselevel) {
					public void rollback() { uselevel = _xdb_saved; }
				};}});
		uselevel = _v_;
	}

	@Override
	public void setPetid(int _v_) { // 原始宠物id
		_xdb_verify_unsafe_();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "petid") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogInt(this, petid) {
	...
	@Override
	public void setQianye(int _v_) { // 千叶值
		_xdb_verify_unsafe_();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "qianye") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogInt(this, qianye) {
					public void rollback() { qianye = _xdb_saved; }
				};}});
		qianye = _v_;
	}

	@Override
	public void setUseqianyecount(int _v_) { // 使用千叶的次数
		_xdb_verify_unsafe_();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "useqianyecount") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogInt(this, useqianyecount) {
					public void rollback() { useqianyecount = _xdb_saved; }
				};}});
		useqianyecount = _v_;
	}

	@Override
	public void setPettaozhuang(int _v_) { // 宠物套装ID
		_xdb_verify_unsafe_();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "pettaozhuang") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogInt(this, pettaozhuang) {
					public void rollback() { pettaozhuang = _xdb_saved; }
				};}});
		pettaozhuang = _v_;
	}
	...
	public final boolean equals(Object _o1_) {
		...
		if (!petequipbag.equals(_o_.petequipbag)) return false;
		if (uselevel != _o_.uselevel) return false;
		if (petid != _o_.petid) return false;
		if (qianye != _o_.qianye) return false;
		if (useqianyecount != _o_.useqianyecount) return false;
		if (pettaozhuang != _o_.pettaozhuang) return false;
		return true;
	}
	...
	public String toString() {
		...
		_sb_.append(",");
		_sb_.append(petequipbag);
		_sb_.append(",");
		_sb_.append(uselevel);
		_sb_.append(",");
		_sb_.append(petid);
		_sb_.append(",");
		_sb_.append(qianye);
		_sb_.append(",");
		_sb_.append(useqianyecount);
		_sb_.append(",");
		_sb_.append(pettaozhuang);
		_sb_.append(")");
	...
	public mkdb.logs.Listenable newListenable() {
		...
		lb.add(new mkdb.logs.ListenableChanged().setVarName("petequipbag"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("uselevel"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("petid"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("qianye"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("useqianyecount"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("pettaozhuang"));
		return lb;
	}
	...
	private class Const implements xbean.PetInfo {
		...
		public java.util.List<xbean.PetSkill> getInternals() { // 宠物拥有的战斗技能
			_xdb_verify_unsafe_();
			return mkdb.Consts.constList(internals);
		}
		...
		public java.util.List<xbean.PetEquipItem> getPetequipbag() { // 宠物装备列表
			_xdb_verify_unsafe_();
			return mkdb.Consts.constList(petequipbag);
		}
	...
	public static final class Data implements xbean.PetInfo {
		...
		public final OctetsStream unmarshal(OctetsStream _os_) throws MarshalException {
			...
			for (int size = _os_.uncompact_uint32(); size > 0; --size) {
				xbean.PetEquipItem _v_ = xbean.Pod.newPetEquipItemData();
				_v_.unmarshal(_os_);
				petequipbag.add(_v_);
			}
			uselevel = _os_.unmarshal_int();
