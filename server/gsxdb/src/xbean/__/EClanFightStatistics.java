...
public final class EClanFightStatistics extends mkdb.XBean implements xbean.EClanFightStatistics {
	private int act; // 行动力，作者 changhao
	private int score; // 积分，作者 changhao
	private long entertime; // 进入战场时间，作者 changhao
	private int winneritemnum; // 获取胜利宝箱的数量，作者 changhao
	private int clancelebrateitemnum; // 获取公会庆祝宝箱的数量，作者 changhao
	private int winnum; // 连续胜利的常数，作者 changhao
	private long lastcbattlefieldrankliststamp; // 上次请求战场积分时间戳，作者 changhao
	private long lastlosestamp; // 上次战败时间戳，作者 changhao
