...
public final class GiveReceGift extends mkdb.XBean implements xbean.GiveReceGift {
	private java.util.HashMap<Integer, Integer> givegift; // 发送礼物 key 为道具itemid value 为数量，作者 changhao
	private java.util.HashMap<Integer, Integer> recegift; // 接收礼物 key 为道具itemid value 为数量，作者 changhao
