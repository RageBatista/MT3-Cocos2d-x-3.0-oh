...
public final class GoldOrder extends mkdb.XBean implements xbean.GoldOrder {
	...
	public void setBuyerid(long _v_) { // 买家ID
		_xdb_verify_unsafe_();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "buyerid") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogLong(this, buyerid) {
					public void rollback() { buyerid = _xdb_saved; }
				};}});
		buyerid = _v_;
	}
	...
	public void setFinishtime(long _v_) { // 完成时间
		_xdb_verify_unsafe_();
		mkdb.Logs.logIf(new mkdb.LogKey(this, "finishtime") {
			protected mkdb.Log create() {
				return new mkdb.logs.LogLong(this, finishtime) {
					public void rollback() { finishtime = _xdb_saved; }
				};}});
		finishtime = _v_;
	}
	...
	public final boolean equals(Object _o1_) {
		...
		if (buyerid != _o_.buyerid) return false;
	...
	public mkdb.logs.Listenable newListenable() {
		...
		lb.add(new mkdb.logs.ListenableChanged().setVarName("buyerid"));
		lb.add(new mkdb.logs.ListenableChanged().setVarName("finishtime"));
		return lb;
	}
