...
public class ActivityManager {
	...
	static private Map<Integer, ScheculedActivity> clanfightpreActivity = new java.util.HashMap<Integer, ScheculedActivity>(); //公会战准备，作者 changhao
	static private Map<Integer, ScheculedActivity> clanfightActivity = new java.util.HashMap<Integer, ScheculedActivity>(); //公会战开始，作者 changhao
	...
	public static void init() throws Exception {
		...
		for (ScheculedActivity activity : activeMap.values()) {
			...
			if (activity.activityid == RoleLiveness.ANSWER_QUESTION)//加入每天的答题活动，作者 changhao
			{
	...
	private static void scheduleRepeatActivity(ScheculedActivity activity)
		...
		// 如果是点卡服,过滤掉氪金和瑟银宝箱[230,231]	add，作者 yebin
