...
*/	
	...
	public final static int TARGET_AIM_CONFIRM_NORMAL8 = 12; // 上上个目标锁敌人，作者 changhao 
	...
	public class SkillError {
		...
		public final static int UnkownError = 9; // 未知错误，作者 changhao
		public final static int LiveSkillIdError = 10; // 生活技能ID错误，作者 changhao
		public final static int MoneyNotEnough = 11; // 金钱不足，作者 changhao
		public final static int ContributeNotEnough = 12; // 公会贡献不足，作者 changhao
		public final static int LevelNotEnough = 13; // 等级不够不能学习，作者 changhao
		public final static int NeedFaction = 14; // 需要公会，作者 changhao
		public final static int SkillMaxLimit = 15; // 技能已经最大了，作者 changhao
		public final static int ItemNotExist = 16; // 道具不存在，作者 changhao
		public final static int OneStuffCannot = 17; // 一个道具不能炼药，作者 changhao
		public final static int SkillLevelNotEnough = 18; // 技能等级不足，作者 changhao
		public final static int NoCookingFood = 19; // 没有可以烹饪的食物，作者 changhao
		public final static int EnergyNotEnough = 20; // 活力不足，作者 changhao
	}
}
