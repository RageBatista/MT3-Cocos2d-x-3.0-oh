...
public class CLiveSkillMakeStuff extends __CLiveSkillMakeStuff__ {
	...
	protected void process() {
		...
		{
			@Override
			/*加锁顺序 team->roleid->match，作者 changhao*/
			...
			{	
				...
				xbean.LiveSkill liveskill = skillrole.getLiveSkills().get(skillid);	//得到生活技能等级，作者 changhao			
				if (liveskill == null)
				{
	...
	public int itemid; // 物品的ID，作者 changhao
	public int itemnum; // 物品数量，作者 changhao
