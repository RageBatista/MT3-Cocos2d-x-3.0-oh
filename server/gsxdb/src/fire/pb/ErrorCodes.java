...
public class ErrorCodes implements Marshal, Comparable<ErrorCodes> {
    ...
    public static final int AddItemToBagException = 1;
    public static final int NotEnoughMoney = 2;
    public static final int EquipPosNotSuit = 3;
    public static final int EquipLevelNotSuit = 4;
    public static final int EquipSexNotSuit = 5;
