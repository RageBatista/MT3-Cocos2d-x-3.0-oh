...
public class RoleLiveness{
	...
	public final static int ANSWER_QUESTION = 213; //答题，作者 changhao
	...
	public final static int CLANFIGHT_PRE = 280; //公会战预备，作者 changhao
	public final static int CLANFIGHT_START = 281; //公会战开始，作者 changhao
