...
import fire.pb.pet.PPetSpeed;
import xbean.Properties;

public class GM_setpetspeed extends GMCommand {
        ...
        if (var1.length < 1) {
            ...
            if (var2 <= 500) {
                ...
                if (var3.getFightpetkey() == -1) {
                    ...
                    PPetSpeed var4 = new PPetSpeed(this.getGmroleid(), var3.getFightpetkey(), var2);
                    var4.submit();
                    return true;
                }
            }
