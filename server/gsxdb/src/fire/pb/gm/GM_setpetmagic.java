...
import fire.pb.pet.PPetMagic;
import xbean.Properties;

public class GM_setpetmagic extends GMCommand {
        ...
        if (var1.length < 1) {
            ...
            if (var2 <= 500) {
                ...
                if (var3.getFightpetkey() == -1) {
                    ...
                    PPetMagic var4 = new PPetMagic(this.getGmroleid(), var3.getFightpetkey(), var2);
                    var4.submit();
                    return true;
                }
            }
