...
import fire.pb.pet.PPetAttack;
import xbean.Properties;

public class GM_setpetattack extends GMCommand {
        ...
        if (var1.length < 1) {
            ...
            if (var2 <= 500) {
                ...
                if (var3.getFightpetkey() == -1) {
                    ...
                    PPetAttack var4 = new PPetAttack(this.getGmroleid(), var3.getFightpetkey(), var2);
                    var4.submit();
                    return true;
                }
            }
