...
import fire.pb.pet.PPetPhyforce;
import xbean.Properties;

public class GM_setpetphyforce extends GMCommand {
        ...
        if (var1.length < 1) {
            ...
            if (var2 <= 500) {
                ...
                if (var3.getFightpetkey() == -1) {
                    ...
                    PPetPhyforce var4 = new PPetPhyforce(this.getGmroleid(), var3.getFightpetkey(), var2);
                    var4.submit();
                    return true;
                }
            }
