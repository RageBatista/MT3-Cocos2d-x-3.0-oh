...
public class Srankawardreward implements ConvMain.Checkable, Comparable<Srankawardreward> {
    public int id = 0;
    ...
    public int compareTo(Srankawardreward srankawardreward) {
        return this.id - srankawardreward.id;
    }

    public Srankawardreward() {
    }

    public Srankawardreward(Srankawardreward srankawardreward) {
