...
public class Srankawardrewarcw implements ConvMain.Checkable, Comparable<Srankawardrewarcw> {
    public int id = 0;
    ...
    public int compareTo(Srankawardrewarcw srankawardreward) {
        return this.id - srankawardreward.id;
    }

    public Srankawardrewarcw() {
    }

    public Srankawardrewarcw(Srankawardrewarcw srankawardreward) {
