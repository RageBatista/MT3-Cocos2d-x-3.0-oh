...
public class Srankawardrewardcw implements ConvMain.Checkable, Comparable<Srankawardrewardcw> {
    public int id = 0;
    ...
    public int compareTo(Srankawardrewardcw srankawardreward) {
        return this.id - srankawardreward.id;
    }

    public Srankawardrewardcw() {
    }

    public Srankawardrewardcw(Srankawardrewardcw srankawardreward) {
