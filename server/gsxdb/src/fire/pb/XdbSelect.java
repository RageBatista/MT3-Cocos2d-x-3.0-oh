...
public class XdbSelect {
	 ...
	 * 
	 * 2.表名.xbean类型名
	 * 		-表名.xbeantypename.basetypename
	 * 		-tablename.xbeantypename.xbeantpename[电位]
	 * 		-表名.xbeantypename.maptypename
	 * 			-表名.xbeantypename.maptypename.mapkeys
	 * 			-tablename.xbeantypename.maptypename.$mapKey
	 * 				-tablename.xbeantypename.maptypename.$mapKey.(xbeantypename[递归]/basetypename)
	 *		-表名称.xbean类型名称.列表类型名称
	 *			-表名称.xbean类型名称.列表类型名称.大小
