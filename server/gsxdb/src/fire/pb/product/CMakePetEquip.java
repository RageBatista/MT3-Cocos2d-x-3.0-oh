...
public class CMakePetEquip extends __CMakePetEquip__ {
    public static final int PROTOCOL_TYPE = 802451;
    public int equipid;
    ...
    protected void process() {
        ...
        if (roleid >= 0L) {
            PMakePetEquip pmakeEquip = new PMakePetEquip(roleid, this.equipid);
            pmakeEquip.submit();
        }
    }
    ...
    public CMakePetEquip() {
    }

    public CMakePetEquip(int _equipid_, short _maketype_) {
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof CMakePetEquip) {
            CMakePetEquip _o_ = (CMakePetEquip)_o1_;
    ...
    public int compareTo(CMakePetEquip _o_) {
        if (_o_ == this) {
            return 0;
        } else {
