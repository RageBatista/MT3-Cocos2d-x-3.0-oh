...
public class BlockInfo {
	...
	public Map<Integer, Byte> loadJumpBlock() {
		...
		try {
			...
			// 此处读整数要按字节翻转
			Integer.reverseBytes(in.readInt()); // 出色地

			Integer.reverseBytes(in.readInt()); // 宽度
			Integer.reverseBytes(in.readInt()); // 高度
	...
	public void loadChannels() {
		...
		final XStream s = XStreamUtil.createXStreamWithDomDriver();
