...
public class Module implements ModuleInterface {
	...
	public void init() throws Exception{
		...
		try {
			...
			ExceptionHandler.handleException(e, "Module.init.yaoqianshuProcedure");
		}
		...
		try {
			...
			ExceptionHandler.handleException(e, "Module.init.loadYaoqianshuNpc2");
		}*/
		...
		try {
			...
			ExceptionHandler.handleException(e, "Module.init.loadRoleYaoqianshuNpc");
		}
	}
