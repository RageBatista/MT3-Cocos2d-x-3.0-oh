...
public class Parser
{
	...
	public static ID2Odds parseIdAndOdds(String str)
	{
		...
		catch(Exception e)
		{
			...
			ExceptionHandler.handleException(e, "fire.pb.util.Parser.parseIdAndOdds");
		}
		return null;
	...
	public static Map<Integer,JavaScript> parseFightJsEffects(String effectstrs) throws Exception
	{
		...
		if(effectstrs !=null && !effectstrs.equals(""))
		{
			...
			catch (Exception e)
			{
				...
				ExceptionHandler.handleException(e, "fire.pb.util.Parser.parseFightJsEffects");
			}
	...
	public static Octets getStringMarshalOctets(String content){
		...
		try {
			...
			ExceptionHandler.handleException(e, "fire.pb.util.Parser.getStringMarshalOctets");
