...
public class CPetSetAutoAddPoint extends __CPetSetAutoAddPoint__ {
    ...
    protected void process() {
        ...
        if (roleid >= 0L) {
            PPetSetAutoAddPointProc proc = new PPetSetAutoAddPointProc(roleid, this.petkey, this.str, this.iq, this.cons, this.endu, this.agi);
            proc.submit();
        }
    }
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof CPetSetAutoAddPoint) {
