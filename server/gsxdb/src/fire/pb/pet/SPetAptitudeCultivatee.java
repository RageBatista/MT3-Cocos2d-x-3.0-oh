...
public class SPetAptitudeCultivatee extends __SPetAptitudeCultivatee__ {
    public static final int PROTOCOL_TYPE = 817964;
    public int petkey;
    public int aptid;
    public int aptvalue;
    ...
    public SPetAptitudeCultivatee() {
    }

    public SPetAptitudeCultivatee(int _petkey_, int _aptid_, int _aptvalue_) {
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof SPetAptitudeCultivatee) {
            SPetAptitudeCultivatee _o_ = (SPetAptitudeCultivatee)_o1_;
    ...
    public int compareTo(SPetAptitudeCultivatee _o_) {
        if (_o_ == this) {
            return 0;
        } else {
            int _c_ = 0;
