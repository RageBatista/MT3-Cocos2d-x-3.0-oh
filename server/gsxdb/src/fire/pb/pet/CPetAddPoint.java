...
public class CPetAddPoint extends __CPetAddPoint__ {
    ...
    protected void process() {
        ...
        if (roleid >= 0L && StateCommon.isOnline(roleid)) {
            if (this.cons != 0 || this.iq != 0 || this.str != 0 || this.endu != 0 || this.agi != 0) {
                PPetAddPointProc proc = new PPetAddPointProc(roleid, this.petkey, this.cons, this.iq, this.str, this.endu, this.agi);
                proc.submit();
            }
        }
    }
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof CPetAddPoint) {
