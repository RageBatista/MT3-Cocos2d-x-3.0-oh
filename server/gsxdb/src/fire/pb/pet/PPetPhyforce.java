...
public class PPetPhyforce extends Procedure {
    private final long roleId;
    private final int petKey;
    private final int petPhyforce;

    public PPetPhyforce(long var1, int var3, int var4) {
        this.roleId = var1;
        this.petKey = var3;
        this.petPhyforce = var4;
    }
    ...
    public boolean process() {
        if (Helper.isPetInBattle(this.roleId, this.petKey)) {
            ...
            if (null == var2) {
                ...
                var2.getPetInfo().setBornphyforceapt(this.petPhyforce);
