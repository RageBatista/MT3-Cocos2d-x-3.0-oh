...
public class CPetSkillCertificationYiWang extends __CPetSkillCertificationYiWang__ {
    public static final int PROTOCOL_TYPE = 817966;
    public int petkey;
    public int skillid;
    ...
    protected void process() {
        ...
        if (roleid >= 0L) {
            PPetSkillCertificationYiWang proc = new PPetSkillCertificationYiWang(roleid, this.petkey, this.skillid, this.isconfirm);
            proc.submit();
        }
    }
    ...
    public CPetSkillCertificationYiWang() {
    }

    public CPetSkillCertificationYiWang(int _petkey_, int _skillid_, int _isconfirm_) {
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof CPetSkillCertificationYiWang) {
            CPetSkillCertificationYiWang _o_ = (CPetSkillCertificationYiWang)_o1_;
    ...
    public int compareTo(CPetSkillCertificationYiWang _o_) {
        if (_o_ == this) {
            return 0;
        } else {
            int _c_ = 0;
