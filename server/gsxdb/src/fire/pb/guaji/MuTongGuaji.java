...
public class MuTongGuaji extends Procedure {
    ...
    public MuTongGuaji(long roleId, int ready, int leixing) {
        this.roleId = roleId;
        this.ready = ready;
    ...
    protected boolean process() {
        ...
        ScheduledFuture newFuture = Mkdb.executor().scheduleAtFixedRate(new MuTongGuajitask(this.roleId, this.leixing, role.getMapId()), 1L, 15L, TimeUnit.SECONDS);
