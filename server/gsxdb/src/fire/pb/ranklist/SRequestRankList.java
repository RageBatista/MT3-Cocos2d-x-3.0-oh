...
public class SRequestRankList extends __SRequestRankList__ {
	...
	public int extdata; // 扩展数据，作者 changhao
	public long extdata1; // 扩展数据，作者 changhao
	public float extdata2; // 扩展数据，作者 changhao
	public java.lang.String extdata3; // 扩展数据，作者 changhao
