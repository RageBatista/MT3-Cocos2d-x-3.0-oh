...
public class SFactionRankInfo extends __SFactionRankInfo__ {
	...
	public long factionkey; // 公会id，作者 changhao
	public java.lang.String lastname; // 曾用名，作者 changhao
	public java.lang.String title; // 宗旨，作者 changhao
	public long factionmasterid; // 会长id，作者 changhao
