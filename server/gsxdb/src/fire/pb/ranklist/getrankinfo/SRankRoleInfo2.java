...
public class SRankRoleInfo2 extends __SRankRoleInfo2__ {
	...
	public long roleid;
	public int ranktype; // 请求的类型，作者 changhao
	...
	public int rank;
	public int totalscore; // 总评分，作者 changhao
	public int rolescore; // 只是人物评分，作者 changhao
	public int petscore; // 宠物评分，作者 changhao
	public int manypetscore; // 多宠物评分，作者 changhao
	public int skillscore; // 技能评分，作者 changhao
	public int levelscore; // 等级评分，作者 changhao
	public int xiulianscore; // 修炼评分，作者 changha
