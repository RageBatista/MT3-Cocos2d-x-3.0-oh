...
public class PRankGetRoleInfo extends Procedure{
	...
	protected boolean process() throws Exception
	{
		...
		else if (rankType == RankType.ROLE_ZONGHE_RANK)
		{
			...
			rankRoleId = record.getRoleid(); //取出对应等级的角色ID，作者 changhao			
		}
		...
		res.petscore = targetRoleProp.getPetscore(); //单宠物，作者 changhao
		res.manypetscore = targetRoleProp.getManypetscore(); //多宠物分数，作者 changhao
