...
public class ClanFightHistroyRank implements Marshal {
    ...
    public ClanFightHistroyRank(int _rank_, long _clanid_, String _clanname_, int _clanlevel_, int _fightcount_, int _wincount_) {
        this.rank = _rank_;
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof ClanFightHistroyRank) {
            ...
            if (this.rank != _o_.rank) {
                ...
                return this.wincount == _o_.wincount;
            }
        } else {
            return false;
        }
