...
public class CAttunement extends __CAttunement__ {
    ...
    protected void process() {
        ...
        if (roleId >= 0L) {
            PAttunement attunement = new PAttunement(roleId, this.keyinpack, this.packid, this.repairtype);
            attunement.submit();
        }
    }
    ...
    public CAttunement(int _repairtype_, int _packid_, int _keyinpack_) {
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof CAttunement) {
            CAttunement _o_ = (CAttunement)_o1_;
    ...
    public int compareTo(CAttunement _o_) {
        if (_o_ == this) {
            return 0;
        } else {
            int _c_ = 0;
