...
public class EquipItemType implements Marshal, Comparable<EquipItemType> {
    ...
    public static final int ADORN = 2;
    public static final int LORICAE = 3;
    public static final int WAISTBAND = 4;
    public static final int BOOT = 5;
    public static final int TIRE = 6;
    public static final int ROLE_COLOR1 = 50;
    public static final int ROLE_COLOR2 = 51;
    public static final int EQUIP_EFFECT = 60;
    public static final int Equipsit = 219;
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            ...
            return _o1_ instanceof EquipItemType;
        }
    }
