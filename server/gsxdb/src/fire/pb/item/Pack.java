...
public class Pack extends ItemMaps {
	...
	public Map<Integer, xbean.Item> getAllItemKey() {
		Map<Integer, xbean.Item> all = new HashMap<Integer, xbean.Item>();
		all.putAll(pack.getItems());
		all.putAll(this.new QuestItemColumn().pack.getItems());
		return all;
	}
