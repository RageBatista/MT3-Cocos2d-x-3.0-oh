...
public class CEquipSetFuMo extends __CEquipSetFuMo__ {
    ...
    public CEquipSetFuMo() {
    }

    public CEquipSetFuMo(int _repairtype_, int _packid_, int _keyinpack_) {
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof CEquipSetFuMo) {
            CEquipSetFuMo _o_ = (CEquipSetFuMo)_o1_;
    ...
    public int compareTo(CEquipSetFuMo _o_) {
        if (_o_ == this) {
            return 0;
        } else {
            int _c_ = 0;
