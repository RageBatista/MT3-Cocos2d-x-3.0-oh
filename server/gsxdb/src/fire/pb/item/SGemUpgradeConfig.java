...
public class SGemUpgradeConfig implements ConvMain.Checkable, Comparable<SGemUpgradeConfig> {
    public int id = 0;
    ...
    public int compareTo(SGemUpgradeConfig o) {
        return this.id - o.id;
    }

    public SGemUpgradeConfig() {
    }

    public SGemUpgradeConfig(SGemUpgradeConfig arg) {
        this.id = arg.id;
