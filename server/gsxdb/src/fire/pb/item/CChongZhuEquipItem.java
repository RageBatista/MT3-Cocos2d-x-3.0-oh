...
public class CChongZhuEquipItem extends __CChongZhuEquipItem__ {
    public static final int PROTOCOL_TYPE = 817942;
    ...
    protected void process() {
        ...
        if (roleId >= 0L) {
            PChongZhuEquipItem pChongZhuEquipItem = new PChongZhuEquipItem(roleId, this.keyinpack, this.packid, this.repairtype);
            pChongZhuEquipItem.submit();
        }
    }
    ...
    public CChongZhuEquipItem() {
    }

    public CChongZhuEquipItem(int _repairtype_, int _packid_, int _keyinpack_) {
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof CChongZhuEquipItem) {
            CChongZhuEquipItem _o_ = (CChongZhuEquipItem)_o1_;
    ...
    public int compareTo(CChongZhuEquipItem _o_) {
        if (_o_ == this) {
            return 0;
        } else {
            int _c_ = 0;
