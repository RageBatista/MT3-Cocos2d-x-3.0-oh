...
public class dongmingcao extends GroceryItem {
    public dongmingcao(ItemMgr paramItemMgr, int paramInt) {
        super(paramItemMgr, paramInt);
    }

    public dongmingcao(ItemMgr paramItemMgr, Item paramItem) {
        super(paramItemMgr, paramItem);
    }

    protected UseItemHandler getUseItemHandler() {
        return new UsedongmingcaoHandler();
    }

    private static class UsedongmingcaoHandler implements UseItemHandler {
        private UsedongmingcaoHandler() {
        }
            ...
            if (paramInt != 1) {
                ...
                if (localMapConfig == null) {
                    ...
                    if (isDynamic) {
                        ...
                        brole.removeCBuff(500008);
                        MessageMgr.psendMsgNotify(roleId, 192813, (List)null);
                    } else {
