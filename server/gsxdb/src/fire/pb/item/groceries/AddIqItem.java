...
public class AddIqItem extends GroceryItem {
    private static int addvalue = 2;

    public AddIqItem(ItemMgr var1, int var2) {
        super(var1, var2);
    }

    public AddIqItem(ItemMgr var1, Item var2) {
        super(var1, var2);
    }
    ...
    private class UseAddPointHandler implements UseItemHandler {
        ...
        public Commontext.UseResult onUse(long var1, ItemBase var3, int var4) {
            ...
            if (var5 == null) {
                ...
                Map var9 = var6.gmAddPoints(0, 0, 0, AddIqItem.addvalue, 0);
                if (var9 != null) {
