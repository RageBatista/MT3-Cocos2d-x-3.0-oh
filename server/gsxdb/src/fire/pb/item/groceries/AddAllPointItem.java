...
public class AddAllPointItem extends GroceryItem {
    private static int addvalue = 1;

    public AddAllPointItem(ItemMgr var1, int var2) {
        super(var1, var2);
    }

    public AddAllPointItem(ItemMgr var1, Item var2) {
        super(var1, var2);
    }
    ...
    private class UseAddPointHandler implements UseItemHandler {
        ...
        public Commontext.UseResult onUse(long var1, ItemBase var3, int var4) {
            ...
            if (var5 == null) {
                ...
                Map var9 = var6.gmAddPoints(AddAllPointItem.addvalue, AddAllPointItem.addvalue, AddAllPointItem.addvalue, AddAllPointItem.addvalue, AddAllPointItem.addvalue);
                if (var9 != null) {
