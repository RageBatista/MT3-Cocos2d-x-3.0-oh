...
public class CAllGemHeCheng extends __CAllGemHeCheng__ {
    ...
    protected void process() {
        ...
        if (roleId >= 0L) {
            PAllGemHeCheng pAllGemHeCheng = new PAllGemHeCheng(roleId, this.keyinpack, this.packid, this.repairtype);
            pAllGemHeCheng.submit();
        }
    }
    ...
    public CAllGemHeCheng() {
    }

    public CAllGemHeCheng(int _repairtype_, int _packid_, int _keyinpack_) {
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof CAllGemHeCheng) {
            CAllGemHeCheng _o_ = (CAllGemHeCheng)_o1_;
    ...
    public int compareTo(CAllGemHeCheng _o_) {
        if (_o_ == this) {
            return 0;
        } else {
            int _c_ = 0;
