...
public class QCRoleInfoDes implements Marshal {
    ...
    public QCRoleInfoDes(long _roleid_, String _rolename_, int _shape_, int _level_, int _school_, int _teamnum_, int _teamnummax_) {
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof QCRoleInfoDes) {
