...
public class BattleEnviroment implements Marshal, Comparable<BattleEnviroment> {
    ...
    public static final int WARM = 1003;
    public static final int COLD = 1004;
    public static final int ORCHID = 1005;
    public static final int THUNDER = 1006;
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            ...
            return _o1_ instanceof BattleEnviroment;
        }
    }
