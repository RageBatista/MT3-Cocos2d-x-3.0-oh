...
public class ResultItem implements Marshal {
    ...
    public LinkedList<SubResultItem> subresultlist;
    ...
    public ResultItem(DemoExecute _execute_, LinkedList<SubResultItem> _subresultlist_, LinkedList<FighterInfo> _newfighter_, HashMap<Integer, Float> _rolechangedattrs_, HashMap<Integer, Float> _petchangedattrs_) {
    ...
    public final boolean _validator_() {
        if (!this.execute._validator_()) {
            ...
            for(SubResultItem _v_ : this.subresultlist) {
                if (!_v_._validator_()) {
                    return false;
                }
            }
    ...
    public OctetsStream unmarshal(OctetsStream _os_) throws MarshalException {
        ...
        for(int _size_ = _os_.uncompact_uint32(); _size_ > 0; --_size_) {
            SubResultItem _v_ = new SubResultItem();
            _v_.unmarshal(_os_);
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof ResultItem) {
