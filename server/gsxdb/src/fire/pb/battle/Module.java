...
public class Module implements ModuleInterface{
	...
	public void init() throws Exception{
		...
		for (SBattleInfo sbattleInfo : sBattleInfos.values())
		{
			try
			{
				...
				if (sbattleInfo.randompos != null) //站位随机，作者 changhao
				{
	...
	public static void serverShutdown()
	{
		...
		{
			ExceptionHandler.handleException(e, "battle.Module.saveAllBattle");
		}
		...
		for(Map.Entry<Long, Integer> entry : battleresults.entrySet())
		{
			...
			{
				ExceptionHandler.handleException(e, "battle.Module.PBattleEnd");
			}
		}
	}
}
