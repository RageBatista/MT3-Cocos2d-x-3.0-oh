...
public class SubResultItem implements Marshal {
    ...
    public LinkedList<DemoResult> resultlist;

    public SubResultItem() {
        this.resultlist = new LinkedList();
    }

    public SubResultItem(int _subskillid_, int _subskillstarttime_, LinkedList<DemoResult> _resultlist_) {
    ...
    public final boolean _validator_() {
        for(DemoResult _v_ : this.resultlist) {
            if (!_v_._validator_()) {
                return false;
            }
        }
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof SubResultItem) {
