...
//			handleLiveDieWin(hostFighters, guestFighters, battle,true);
			...
			//系统提示
			MessageMgr.sendSystemMsg(162069,Arrays.<String>asList(hostname,hostname,guestname));
			break;
...
//			handleLiveDieWin(guestFighters, hostFighters, battle,false);
			...
			//系统提示
			MessageMgr.sendSystemMsg(162069,Arrays.<String>asList(guestname,guestname,hostname));
			break;
		default:
			break;
		}
...
//			transformRoleids.add(roleid);
			...
			//您因死亡损失了10%的装备耐久
//			MessageMgr.psendMsgNotifyWhileCommit(roleid, 162084,Arrays.<String>asList(times+""));
			MessageMgr.psendSystemMessageToRole(roleid, 162084,Arrays.<String>asList(times+""));
