		...
		new mkdb.Procedure() {
			protected boolean process() throws Exception {
				...
				if(acceptresult==1){//接受
					...
					MessageMgr.sendSystemMsg(162067,Arrays.<String>asList(guestname,hostname));
					...
					//给好友提示
					MessageMgr.psendSystemMessageToRole(hostid,162115,Arrays.<String>asList(guestname));
					fire.pb.talk.MessageMgr.sendMsgNotify(hostid, 162114,Arrays.<String>asList(guestname));
					//添加战斗
					...
					//给好友提示
					MessageMgr.psendSystemMessageToRole(hostid, 162087,Arrays.<String>asList(guestname));
					MessageMgr.sendSystemMsg(162068,Arrays.<String>asList(guestname,hostname));
