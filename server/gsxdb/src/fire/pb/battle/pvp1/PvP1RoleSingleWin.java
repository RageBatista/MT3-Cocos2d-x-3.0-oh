...
public class PvP1RoleSingleWin implements Marshal {
    ...
    public PvP1RoleSingleWin(long _roleid_, String _rolename_, int _combonum_) {
    ...
    public OctetsStream unmarshal(OctetsStream _os_) throws MarshalException {
        ...
        this.combonum = _os_.unmarshal_int();
        return _os_;
    }
    ...
    public boolean equals(Object _o1_) {
        if (_o1_ == this) {
            return true;
        } else if (_o1_ instanceof PvP1RoleSingleWin) {
            ...
            if (this.roleid != _o_.roleid) {
                ...
                return this.combonum == _o_.combonum;
            }
        } else {
            return false;
        }
    ...
    public String toString() {
        ...
        _sb_.append(this.combonum).append(",");
        _sb_.append(")");
