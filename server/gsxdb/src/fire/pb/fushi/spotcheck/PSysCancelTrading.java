...
public class PSysCancelTrading extends Procedure {
	...
	protected boolean process() throws Exception {
		...
		if(roleTradingRecord.getTradingtype()==SpotCheckManage.TYPE_BUY){
			...
			MessageMgr.psendSystemMessageToRole(roleid, 190045,Arrays.<String>asList(addgold+""));
			...
			MessageMgr.psendSystemMessageToRole(roleid, 190042,Arrays.<String>asList(roleTradingRecord.getCurnum()+""));
		}
		//运营日志
