...
public class CGrabMonthCardReward extends __CGrabMonthCardReward__ {
			...
			protected boolean process()
			{
				...
				if (true)
				{
					...
					if (fire.pb.fushi.Module.GetPayServiceType() == 1) //点卡服务器，作者 changhao
					{
						...
						if (count > e.getNum()) //数量超限制 回滚，作者 changhao
						{
							return false;
						}
					}
	...
	public int itemid; // 自由分配道具id，作者 changhao
	public java.util.HashMap<Integer,Integer> rewarddistribution; // 道具分配 道具id value数量，作者 changhao
