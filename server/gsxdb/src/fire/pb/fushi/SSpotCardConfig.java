...
public class SSpotCardConfig implements ConvMain.Checkable, Comparable<SSpotCardConfig> {
    public int id = 0;
    ...
    public double tradingmoney = (double)0.0F;
    public double tradingshui = (double)0.0F;
