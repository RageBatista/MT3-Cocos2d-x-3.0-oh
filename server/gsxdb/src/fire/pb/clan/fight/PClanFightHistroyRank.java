...
public class PClanFightHistroyRank extends mkdb.Procedure
{
	...
	{	
		...
		java.util.Map<Long, ActivityClanFightManager.ClanFightStatisticsInfo> infos = ActivityClanFightManager.getInstance().CalcClanStatistics(24);//24轮一个赛季，作者 changhao
