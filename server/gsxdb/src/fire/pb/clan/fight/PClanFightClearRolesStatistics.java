...
public class PClanFightClearRolesStatistics extends mkdb.Procedure
{
	...
	@Override
	/***
	 * clanfightid -> roleids，作者 changhao
	 */
	...
	{	
		...
		lock(mkdb.Lockeys.get(xtable.Locks.ROLELOCK, bf.getClanfightBean().getEnterroleids().keySet())); //锁定roleids，作者 changhao		
