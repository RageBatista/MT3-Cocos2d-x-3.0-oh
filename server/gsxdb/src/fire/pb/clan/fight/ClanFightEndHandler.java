...
/***
 * 帮会战 战后处理，作者 changhao
 */
public class ClanFightEndHandler extends BattleEndHandler {

	public long clanfightid; //公会战id，作者 changhao
	public long attackerid; //攻击者，作者 changhao
	public long targetid; //被攻击者，作者 changhao
	public long attackerclanid; //攻击方公会id，作者 changhao
	public long clandid;//被攻击方公会id，作者 changhao
