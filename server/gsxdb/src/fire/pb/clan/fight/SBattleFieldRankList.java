...
public class SBattleFieldRankList extends __SBattleFieldRankList__ {
	...
	public int clanscore1; // 公会1积分，作者 changhao
	public int clanscroe2; // 公会2积分，作者 changhao
	public java.util.LinkedList<fire.pb.clan.fight.RoleBattleFieldRank> ranklist1; // 战场积分排名list，作者 changhao
	public java.util.LinkedList<fire.pb.clan.fight.RoleBattleFieldRank> ranklist2; // 战场积分排名list，作者 changhao
	public int myscore; // 我的积分，作者 changhao
	public int myrank; // 我的排名(从0开始)，作者 changhao
