...
public class SGetClanFightList extends __SGetClanFightList__ {
	...
	public java.util.LinkedList<fire.pb.clan.fight.ClanFight> clanfightlist; // 当前这轮的对阵信息链表，作者 changhao
	public int curweek; // 当前轮数(从0开始, 返回-1表示还没开始或已经过了8轮)，作者 changhao
	public int over; // 0是没结束1是已结束，作者 changhao
