...
public class PBuyMedic extends Procedure {
	...
	protected boolean process() throws Exception {
		...
		//提示消耗钱
		fire.pb.talk.MessageMgr.sendMsgNotify(roleid, 160375,Arrays.<String>asList(costmoney+""));
		
		fire.pb.clan.srv.ClanManage.delContribution(roleid, costcontri, "购买帮派药品", false);//扣除帮贡
		fire.pb.talk.MessageMgr.sendMsgNotify(roleid, 160313,Arrays.<String>asList(costcontri+""));//消耗帮贡提示
		//设置剩余物品数量
		...
		if(iAttr!=null){
			fire.pb.talk.MessageMgr.sendMsgNotify(roleid, 160374,Arrays.<String>asList(iAttr.getName()));
		}
