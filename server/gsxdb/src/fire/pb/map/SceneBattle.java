...
/*	public static void activeMonstershowBattle( Role role, long monsterkey, long curTick ) {
	 ...
	 * @param curTick		当前时刻
	 */
	public static void process(/*RoleHideBattleInfo 角色，*/Role role, int newRoadLen, long curTick,int conf){
...
//				Message.sendPopByRoleID(role.getRoleID(), "步数清0,现在步数:"+role.getRoadLen()/16/3);
	 ...
	 * @返回
	 */
	public static boolean checkSpecialPatrol(/*RoleHideBattleInfo 角色，*/Role role, int newRoadLen){
