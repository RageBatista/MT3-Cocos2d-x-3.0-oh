...
public class ActivityQuestionManager<q> {
		...
		new mkdb.Procedure(){
			...
			protected boolean process() throws Exception
			{
				...
				if (actrole != null)
				{
					...
					if (count < activity.maxnum && start == true) //一天次数上限，作者 changhao
					{
	...
	public void ResetActivityQuestionData(xbean.ActivityQuestion activityquestion, long now, boolean clearreward)
	{
		...
		int[] questionlists = Misc.getRandomArray(tmp, QuestionManager.ActivityAnswerQuestionNum); //随机取一些题目，作者 changhao
