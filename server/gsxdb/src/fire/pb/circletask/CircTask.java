...
public class CircTask implements ConvMain.Checkable, Comparable<CircTask> {
    public int id = 0;
    public int type = 0;
    ...
    public ArrayList<String> questrate;
    ...
    public ArrayList<String> teamleaderaward;
    ...
    public ArrayList<String> getQuestrate() {
        return this.questrate;
    }

    public void setQuestrate(ArrayList<String> v) {
        this.questrate = v;
    }
    ...
    public ArrayList<String> getTeamleaderaward() {
        return this.teamleaderaward;
    }

    public void setTeamleaderaward(ArrayList<String> v) {
