...
public class RoleConfigManager {
	...
	public static SCommon getRoleRFrankingConfig(int id) {
		return getRoleCommonConfig(id);
	}

	public static SCommon getRoleStsommonConfig(int id) {
		return getRoleCommonConfig(id);
	}

	public static SCommon getRoleWeeklyrewards(int id) {
		return getRoleCommonConfig(id);
	}
