...
public enum Shouxi {
    ...
    NUERCUN(SchoolConst.NUERCUN_SHOUXI),
    XIAOLEIYIN(SchoolConst.XIAOLEIYIN_SHOUXI),
    HUAGUOSHAN(SchoolConst.HUAGUOSHAN_SHOUXI),
    XUMIHAI(SchoolConst.XUMIHAI_SHOUXI),
    PANSI(SchoolConst.PANSI_SHOUXI);
