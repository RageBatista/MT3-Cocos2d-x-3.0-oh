...
public class PEquipUpgrade extends Procedure {
    ...
    public PEquipUpgrade(long roleid, int srcweaponkey) {
        ...
        if (oldWeaponIB == null) {
            ...
            if (Module.existState(this.roleid, 507004)) {
                ...
                if (itemdata == null) {
                    ...
                    SEquipUpgradeConfig conf = (SEquipUpgradeConfig)upgradeMap.get(itemID);
                    ...
                    if (havenum < needitemcount) {
                        ...
                        int neeweaponid = conf.oldEquipID;
                        ...
                        if (haveweaponnum < needweaponcount) {
                            ...
                            boolean ok = FushiManager.subFushiFromUser(userid, this.roleid, Integer.parseInt(String.valueOf(conf.needCold)), 0, 0, 2006, YYLoggerTuJingEnum.tujing_Value_monthcard, true);
                            if (!ok) {
