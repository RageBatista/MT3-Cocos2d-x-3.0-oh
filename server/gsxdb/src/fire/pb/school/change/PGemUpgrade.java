...
import fire.pb.item.SGemUpgradeConfig;
...
public class PGemUpgrade extends Procedure {
    public int srcitemkey;
    public long roleid;
    private static Logger logger = Logger.getLogger("ITEM");
    public static final Map<Integer, SGemUpgradeConfig> upgradeMap = ConfigManager.getInstance().getConf(SGemUpgradeConfig.class);

    public PGemUpgrade(long roleid, int srcitemkey) {
    ...
    protected boolean process() throws Exception {
        ...
        SGemUpgradeConfig conf = (SGemUpgradeConfig)upgradeMap.get(itemID);
                    ...
                    if (delnum != needitemcount) {
                        ...
                        if (removenum != needweaponcount) {
                            ...
                            if (iAttr == null) {
                                ...
                                SGemUpgrade sendResult = new SGemUpgrade();
