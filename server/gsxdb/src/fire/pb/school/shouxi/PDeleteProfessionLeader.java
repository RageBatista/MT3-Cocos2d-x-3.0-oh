	...
	protected boolean process() throws Exception
	{
		...
		if (sxi != null)
		{
			if (sxi.getRoleid() == roleid)
			{
				...
				//删除职业领袖称谓，作者 changhao
				fire.pb.school.School s = fire.pb.school.SchoolManager.getSchoolById(oldschool);
				int titleID = s.getInfo().shouxiTitleId;
