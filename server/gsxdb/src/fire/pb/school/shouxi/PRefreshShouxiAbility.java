...
public class PRefreshShouxiAbility extends Procedure {
	...
	protected boolean process() throws Exception {
		...
		School npcSchool = fire.pb.school.SchoolManager.getSchoolByShouxiNpcId(npcid);
		// 门派不对,直接返回
		...
		if (shouxiInfo == null || shouxiInfo.getRoleid() != roleid) {
			...
			xbean.Monster monsterBean = fire.pb.battle.Monster.copyMonsterFromRoleOrPet(roleid, npcSchool.getInfo().shouxiBattleNpcId,true,0);
