...
public class PSendElectorWords extends Procedure {
	...
	protected boolean process() throws Exception
	{
		...
		if (modifyelectwords == false)
		{
			...
			//把竞选者的能力存下来，作者 changhao
			xbean.Monster monsterBean = null;
			School s = SchoolManager.getSchoolById(school);
			monsterBean = Monster.copyMonsterFromRoleOrPet(roleid, s.getInfo().shouxiBattleNpcId, true, 0);
