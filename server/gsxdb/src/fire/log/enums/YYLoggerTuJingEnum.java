...
//===========以下是物品或代币获取方式的枚举值===========
	...
	,tujing_Value_monthcard_reward(1071)//月卡奖励，作者 changhao
	,tujing_Value_liansheng_reward(1072)// 连胜宝箱，作者 changhao	
	,tujing_Value_clanfight_reward(1073)// clanfight，作者 changhao	
	,tujing_Value_clanfight_dkp(1074)// clanfight，作者 changhao
...
//===========以下是物品或代币消耗方式的枚举值===========
	...
	,tujing_Value_campaign(2145)//职业领袖竞选，作者 changhao
	...
	,tujing_Value_daypa(2150)//日卡，作者 changhao
	...
	,tujing_Value_worldchat_enery(2155)//世界聊天活力消耗，作者 changhao
	,tujing_Value_professionleader_titletask(2156)//职业任务称号，作者 changhao
	,tujing_Value_renxingmaxituan(2157)//任性马戏团
	,tujing_Value_monthcard(2158)//月卡，作者 changhao
