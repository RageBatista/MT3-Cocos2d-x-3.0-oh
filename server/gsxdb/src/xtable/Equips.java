...
public class Equips {
	...
	public static Integer selectNewskill(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Equip, Integer>() {
				public Integer get(xbean.Equip v) { return v.getNewskill(); }
			});
	}
	...
	public static Integer selectNeweffect(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Equip, Integer>() {
				public Integer get(xbean.Equip v) { return v.getNeweffect(); }
			});
	}
	...
	public static java.util.Map<Integer, Integer> selectExtraattr(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Equip, java.util.Map<Integer, Integer>>() {
				public java.util.Map<Integer, Integer> get(xbean.Equip v) { return v.getExtraattrAsData(); }
			});
	}

	public static java.util.Map<Integer, Integer> selectExtraaddattr(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Equip, java.util.Map<Integer, Integer>>() {
				public java.util.Map<Integer, Integer> get(xbean.Equip v) { return v.getExtraaddattrAsData(); }
			});
	}
	...
	public static Integer selectTaozhuangeffectid(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Equip, Integer>() {
				public Integer get(xbean.Equip v) { return v.getTaozhuangeffectid(); }
			});
	}
	...
	public static Integer selectEquipsit(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Equip, Integer>() {
				public Integer get(xbean.Equip v) { return v.getEquipsit(); }
			});
	}
