...
public class Equiptab {
	...
	public static Integer selectNeweffect(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.EquipItem, Integer>() {
				public Integer get(xbean.EquipItem v) { return v.getNeweffect(); }
			});
	}
	...
	public static Integer selectNewskill(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.EquipItem, Integer>() {
				public Integer get(xbean.EquipItem v) { return v.getNewskill(); }
			});
	}
	...
	public static java.util.Map<Integer, Integer> selectExtraattr(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.EquipItem, java.util.Map<Integer, Integer>>() {
				public java.util.Map<Integer, Integer> get(xbean.EquipItem v) { return v.getExtraattrAsData(); }
			});
	}

	public static java.util.Map<Integer, Integer> selectExtraaddattr(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.EquipItem, java.util.Map<Integer, Integer>>() {
				public java.util.Map<Integer, Integer> get(xbean.EquipItem v) { return v.getExtraaddattrAsData(); }
			});
	}
	...
	public static Integer selectEquipsit(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.EquipItem, Integer>() {
				public Integer get(xbean.EquipItem v) { return v.getEquipsit(); }
			});
	}
