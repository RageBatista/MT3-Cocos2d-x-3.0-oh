...
public class Properties {
	...
	public static java.util.Map<Integer, xbean.Jingmai> selectJingmai(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Properties, java.util.Map<Integer, xbean.Jingmai>>() {
				public java.util.Map<Integer, xbean.Jingmai> get(xbean.Properties v) { return v.getJingmaiAsData(); }
			});
	}
	...
	public static java.util.List<Long> selectJblb(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Properties, java.util.List<Long>>() {
				public java.util.List<Long> get(xbean.Properties v) { return v.getJblbAsData(); }
			});
	}
	...
	public static java.util.Map<Integer, Integer> selectShizhuang(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Properties, java.util.Map<Integer, Integer>>() {
				public java.util.Map<Integer, Integer> get(xbean.Properties v) { return v.getShizhuangAsData(); }
			});
	}
	...
	public static Integer selectZhuansheng(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Properties, Integer>() {
				public Integer get(xbean.Properties v) { return v.getZhuansheng(); }
			});
	}

	public static Integer selectBsitem(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Properties, Integer>() {
				public Integer get(xbean.Properties v) { return v.getBsitem(); }
			});
	}

	public static Integer selectZqitem(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Properties, Integer>() {
				public Integer get(xbean.Properties v) { return v.getZqitem(); }
			});
	}

	public static java.util.Map<Integer, Integer> selectZuoqi(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Properties, java.util.Map<Integer, Integer>>() {
				public java.util.Map<Integer, Integer> get(xbean.Properties v) { return v.getZuoqiAsData(); }
			});
	}

	public static java.util.List<String> selectBenefitcode(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Properties, java.util.List<String>>() {
				public java.util.List<String> get(xbean.Properties v) { return v.getBenefitcodeAsData(); }
			});
	}

	public static Long selectPartnerid(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Properties, Long>() {
				public Long get(xbean.Properties v) { return v.getPartnerid(); }
			});
	}

	public static java.util.Map<Integer, Integer> selectQlgmap(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Properties, java.util.Map<Integer, Integer>>() {
				public java.util.Map<Integer, Integer> get(xbean.Properties v) { return v.getQlgmapAsData(); }
			});
	}

	public static Integer selectQlgcurrextra(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Properties, Integer>() {
				public Integer get(xbean.Properties v) { return v.getQlgcurrextra(); }
			});
	}

	public static java.util.Map<Integer, xbean.FunOpenClose> selectQlgextrapromap(Long key) {
		return getTable().select(key, new mkdb.TField<xbean.Properties, java.util.Map<Integer, xbean.FunOpenClose>>() {
				public java.util.Map<Integer, xbean.FunOpenClose> get(xbean.Properties v) { return v.getQlgextrapromapAsData(); }
			});
	}
