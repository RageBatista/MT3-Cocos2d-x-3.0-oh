...
public class _DatabaseMetaData_ extends mkdb.util.DatabaseMetaData {
	...
	public void DatabaseMetaData1(){
		// xbeans
		{
			Bean bean = new Bean("DayCount", false, false);
		...
		{
			Bean bean = new Bean("DayCounter", false, false);
			super.addVariableFor(bean
				, "countermap"
				, "map", "int", "DayCount", ""
				, "", "", ""
		...
		{
			Bean bean = new Bean("TempTime", false, false);
			super.addVariableFor(bean
				, "items"
				, "map", "int", "long", ""
				, "", "", ""
		...
		{
			Bean bean = new Bean("PotentialExtra", false, false);
			super.addVariableFor(bean
				, "extramap"
				, "map", "int", "int", ""
				, "", "", ""
		...
		{
			Bean bean = new Bean("PetEquipItem", false, false);
			super.addVariableFor(bean
				, "id"
				, "long", "", "", ""
				, "0", "", ""
		...
		{
			Bean bean = new Bean("jiebaiAskInfo", false, false);
			super.addVariableFor(bean
				, "titlename"
				, "string", "", "", ""
				, "", "", ""
		...
		{
			Bean bean = new Bean("BitcoinNum", false, false);
			super.addVariableFor(bean
				, "num"
				, "int", "", "", ""
				, "", "", ""
		...
		{
			Bean bean = new Bean("BitcoinNums", false, false);
			super.addVariableFor(bean
				, "rolebitcoin"
				, "map", "long", "BitcoinNum", ""
				, "", "", ""
	...
	public void DatabaseMetaData2(){
		...
		{
			Bean bean = new Bean("XingChenItem", false, false);
			super.addVariableFor(bean
				, "id"
				, "int", "", "", ""
				, "", "", ""
		...
		{
			Bean bean = new Bean("Jingmai", false, false);
			super.addVariableFor(bean
				, "id"
				, "int", "", "", ""
				, "", "", ""
	...
	public void DatabaseMetaData4(){
		...
		{
			Bean bean = new Bean("TotalInfo", false, false);
			super.addVariableFor(bean
				, "total"
				, "long", "", "", ""
				, "", "", ""
	...
	public void DatabaseMetaData5(){
		...
		{
			Bean bean = new Bean("TradingLock", false, false);
			super.addVariableFor(bean
				, "tradingid"
				, "long", "", "", ""
				, "", "", ""
		...
		{
			Bean bean = new Bean("GuajiTaskState", false, false);
			super.addVariableFor(bean
				, "guajitypeids"
				, "list", "", "int", ""
				, "", "", ""
		...
		super.addTable("totalrecharge", "DB", "long", false, "TotalInfo", "key:properties", "");
	...
	public void DatabaseMetaData6(){
		...
		super.addTable("jiebaiinfos", "DB", "long", false, "jiebaiAskInfo", "", "");
		...
		super.addTable("petequips", "DB", "long", true, "PetEquipItem", "", "");
		...
		super.addTable("bitcoinnum", "DB", "int", false, "BitcoinNums", "", "");
		...
		super.addTable("guajitasks", "DB", "long", false, "GuajiTaskState", "key:properties", "");
	...
	public void DatabaseMetaData7(){
		...
		super.addTable("dailyrecharge", "DB", "long", false, "DailyInfo", "key:properties", "");
		...
		super.addTable("temptime", "MEMORY", "long", false, "TempTime", "", "");
		...
		super.addTable("daycounter", "DB", "long", true, "DayCounter", "", "");
	...
	public void DatabaseMetaData8(){
		...
		super.addTable("tradinglock", "MEMORY", "long", false, "TradingLock", "key:properties", "");
