...
public final class Locks {
	...
	public static final mkdb.TTable<?,?> CLANS = _Tables_.getInstance().clanid2clanfightids; // 氏族  
	...
	public static final mkdb.TTable<?,?> PETEQUIPS = _Tables_.getInstance().petequips; // 
	...
	public static final mkdb.TTable<?,?> ROLELOCK = _Tables_.getInstance().acceptedscenariomission; // 节日friendgivenum朋友frolefushirecordtableguajitaskshelpcounthuobancolumns火斑真荣邀请人信息项恢复解百信息ldvideoroleroseinfolisttab livedie2key liveieroleinfolisttab Majorscenariomission marketpet markettradelogtab menstor modnameitemroles multiexp npcfollowroles离线未来离线msg onetimeeventtab online刷新pet petdepot petrecover属性pvp1roles pvp3roles pvp5roles questbag redpackroleinfolisttab regtbl请求转到角色2npcawards角色2weibonotify角色applyclantab角色bestow角色buygoodslimits角色circletask角色circletaskcomplete角色clanpoint角色doublecharge角色hook角色id2activityquestionroleid2battleidroleid2battlemelonidroleid2bjroleid2chargereturnprofitroleid2clanfightidroleid2clanfightstatisticsroleid2kickinforoleid2liveskillroleid2monthcard roleid2articleskill roleid2teamid roleid2userid roleid2weekgiverecegift roleid2worldredpacksendtotal roleidclan role凯宝祥角色kaigonghuibaoxiang rolelockscreen rolemuldayloginreward roleofflinehook roleonoffstate rolepetsellcount roleposes roleranknotifytime rolereceiveredpackrecordtab rolerecourse rolerecruitaward roleredpackrecordtab rolerenxingdata rolerollcard rolesafelock角色销售商品限制角色收费限制角色节日数据角色空间角色特殊任务计时器角色扮演活跃角色扮演活跃周角色任务事件选项卡角色任务角色交易他的记录列表选项卡角色交易信息列表选项卡角色更新模型数字选项卡角色更新时间选项卡角色使用项目计数角色姚千舒表符文信息选项卡单邀请技能角色srredpacknumlisttab订阅收回市场容器选项卡团队邀请临时计时奖励总充值跟踪任务交易锁transformbyitem transfromroles 触发器角色 vipinfo watcherid2battleid 轮进度 worldeventtab  
	...
	public static final mkdb.TTable<?,?> TEAMLOCK = _Tables_.getInstance().instanceaskinfos; // 团队团队过滤器  
	public static final mkdb.TTable<?,?> TEAMMATCHLOCK = _Tables_.getInstance().targetid2teammatch; // 
	public static final mkdb.TTable<?,?> TEMPTIME = _Tables_.getInstance().temptime; // 
	...
	public static final mkdb.TTable<?,?> USERLOCK = _Tables_.getInstance().bitcoinnum; // 充电历史firstcharge新fushinum lianyuna奖励用户yybfushi  
