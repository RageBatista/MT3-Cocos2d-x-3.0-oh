...
SERVICE_PORT="${SERVICE_PORT:-22200}"
SERVICE_PORTS="${SERVICE_PORTS:-22200}"
PROCESS_PATTERN="${PROCESS_PATTERN:-com\\.locojoy\\.ns\\.Main|ns\\.jar}"
...
start() {
    ...
    rm -f "$SCRIPT_DIR/nsdb/mkdb.inuse"
    ...
    cmd+=(-cp "./lib/jio.jar:./lib/monkeyking.jar:ns.jar" com.locojoy.ns.Main nsdb.xml)
