...
public class Flush2 {
	...
	public static xbean.Flush get(Integer key) {
		return _Tables_.getInstance().flush2.get(key);
	}

	public static xbean.Flush get(Integer key, xbean.Flush value) {
		return _Tables_.getInstance().flush2.get(key, value);
	}

	public static void insert(Integer key, xbean.Flush value) {
		_Tables_.getInstance().flush2.insert(key, value);
	}

	public static void delete(Integer key) {
		_Tables_.getInstance().flush2.delete(key);
	}

	public static boolean add(Integer key, xbean.Flush value) {
		return _Tables_.getInstance().flush2.add(key, value);
	}

	public static boolean remove(Integer key) {
		return _Tables_.getInstance().flush2.remove(key);
	}

	public static mkdb.TTableCache<Integer, xbean.Flush> getCache() {
		return _Tables_.getInstance().flush2.getCache();
	}

	public static mkdb.TTable<Integer, xbean.Flush> getTable() {
		return _Tables_.getInstance().flush2;
	}
