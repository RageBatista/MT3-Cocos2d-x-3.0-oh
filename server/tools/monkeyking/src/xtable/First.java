...
public class First {
	...
	public static xbean.First get(Long key) {
		return _Tables_.getInstance().first.get(key);
	}

	public static xbean.First get(Long key, xbean.First value) {
		return _Tables_.getInstance().first.get(key, value);
	}

	public static void insert(Long key, xbean.First value) {
		_Tables_.getInstance().first.insert(key, value);
	}

	public static void delete(Long key) {
		_Tables_.getInstance().first.delete(key);
	}

	public static boolean add(Long key, xbean.First value) {
		return _Tables_.getInstance().first.add(key, value);
	}

	public static boolean remove(Long key) {
		return _Tables_.getInstance().first.remove(key);
	}

	public static mkdb.TTableCache<Long, xbean.First> getCache() {
		return _Tables_.getInstance().first.getCache();
	}

	public static mkdb.TTable<Long, xbean.First> getTable() {
		return _Tables_.getInstance().first;
	}
