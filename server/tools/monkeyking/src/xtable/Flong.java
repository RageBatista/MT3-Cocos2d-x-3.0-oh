...
public class Flong {
	...
	public static Integer get(Long key) {
		return _Tables_.getInstance().flong.get(key);
	}

	public static Integer get(Long key, Integer value) {
		return _Tables_.getInstance().flong.get(key, value);
	}

	public static void insert(Long key, Integer value) {
		_Tables_.getInstance().flong.insert(key, value);
	}

	public static void delete(Long key) {
		_Tables_.getInstance().flong.delete(key);
	}

	public static boolean add(Long key, Integer value) {
		return _Tables_.getInstance().flong.add(key, value);
	}

	public static boolean remove(Long key) {
		return _Tables_.getInstance().flong.remove(key);
	}

	public static mkdb.TTableCache<Long, Integer> getCache() {
		return _Tables_.getInstance().flong.getCache();
	}

	public static mkdb.TTable<Long, Integer> getTable() {
		return _Tables_.getInstance().flong;
	}
