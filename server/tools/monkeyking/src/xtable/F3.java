...
public class F3 {
	...
	public static xbean.fxbean get(String key) {
		return _Tables_.getInstance().f3.get(key);
	}

	public static xbean.fxbean get(String key, xbean.fxbean value) {
		return _Tables_.getInstance().f3.get(key, value);
	}

	public static void insert(String key, xbean.fxbean value) {
		_Tables_.getInstance().f3.insert(key, value);
	}

	public static void delete(String key) {
		_Tables_.getInstance().f3.delete(key);
	}

	public static boolean add(String key, xbean.fxbean value) {
		return _Tables_.getInstance().f3.add(key, value);
	}

	public static boolean remove(String key) {
		return _Tables_.getInstance().f3.remove(key);
	}

	public static mkdb.TTableCache<String, xbean.fxbean> getCache() {
		return _Tables_.getInstance().f3.getCache();
	}

	public static mkdb.TTable<String, xbean.fxbean> getTable() {
		return _Tables_.getInstance().f3;
	}
