...
public class Memory {
	...
	public static Integer get(Integer key) {
		return _Tables_.getInstance().memory.get(key);
	}

	public static Integer get(Integer key, Integer value) {
		return _Tables_.getInstance().memory.get(key, value);
	}

	public static void insert(Integer key, Integer value) {
		_Tables_.getInstance().memory.insert(key, value);
	}

	public static void delete(Integer key) {
		_Tables_.getInstance().memory.delete(key);
	}

	public static boolean add(Integer key, Integer value) {
		return _Tables_.getInstance().memory.add(key, value);
	}

	public static boolean remove(Integer key) {
		return _Tables_.getInstance().memory.remove(key);
	}

	public static mkdb.TTableCache<Integer, Integer> getCache() {
		return _Tables_.getInstance().memory.getCache();
	}

	public static mkdb.TTable<Integer, Integer> getTable() {
		return _Tables_.getInstance().memory;
	}
