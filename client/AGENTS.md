...
- tolua++ 生成的绑定 `.cpp`（如 `FireClient/Application/Framework/LuaFireClient.cpp`、`LuaEngine.cpp`）与 `client/FireClient/Application/ProtoDef/**` 默认视为生成物，修改应回到 `client/tolua++-pkgs/**/*.pkg` 等源定义。
