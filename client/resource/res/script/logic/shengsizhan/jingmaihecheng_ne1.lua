...
jingmaihecheng_ne1 = {}
setmetatable(jingmaihecheng_ne1, Dialog)
jingmaihecheng_ne1.__index = jingmaihecheng_ne1

local _instance
function jingmaihecheng_ne1.getInstance()
	if not _instance then
		_instance = jingmaihecheng_ne1:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_ne1.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_ne1:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_ne1.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_ne1.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_ne1.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_ne1:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_ne1.GetLayoutFileName()
	return "jingmaihecheng_ne.layout"
end

function jingmaihecheng_ne1:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_ne1)
	return self
end

function jingmaihecheng_ne1:OnCreate()
...
function jingmaihecheng_ne1:OnCreate()
	...
	self.m_nebiaoti3:setVisible(false)
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1ne1:subscribeEvent("Clicked", jingmaihecheng_ne1.hc1ne1, self)
	self.m_hc1ne2:subscribeEvent("Clicked", jingmaihecheng_ne1.hc1ne2, self)
	self.m_hc1ne3:subscribeEvent("Clicked", jingmaihecheng_ne1.hc1ne3, self)
	self.m_hc1ne4:subscribeEvent("Clicked", jingmaihecheng_ne1.hc1ne4, self)
	self.m_hc1ne5:subscribeEvent("Clicked", jingmaihecheng_ne1.hc1ne5, self)
	self.m_hc1ne6:subscribeEvent("Clicked", jingmaihecheng_ne1.hc1ne6, self)
	self.m_hc1ne7:subscribeEvent("Clicked", jingmaihecheng_ne1.hc1ne7, self)
	self.m_hc1ne8:subscribeEvent("Clicked", jingmaihecheng_ne1.hc1ne8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_ne1.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1ne1 = 8022011
TaskHelper.m_hc1ne2 = 8022012
TaskHelper.m_hc1ne3 = 8022013
TaskHelper.m_hc1ne4 = 8022014
TaskHelper.m_hc1ne5 = 8022015
TaskHelper.m_hc1ne6 = 8022016
TaskHelper.m_hc1ne7 = 8022017
TaskHelper.m_hc1ne8 = 8022018

-- function jingmaihecheng_ne1:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_ne1:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_ne1:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_ne1:jingmaibeibao(args)
