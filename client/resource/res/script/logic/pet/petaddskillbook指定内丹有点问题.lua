			 ...
			 if self.cellid then
                if self.cellid==5 then
					if cell.itemData:GetBaseObject().nquality~=5 then
                        GetCTipsManager():AddMessageTipById(201063)
	 
						return 
					end
				elseif self.cellid==6 then
					--判断低级内胆不能选高级
					if cell.itemData:GetBaseObject().nquality~=4 then
                        GetCTipsManager():AddMessageTipById(201064)
	 
						return 
					end
				else
					if cell.itemData:GetBaseObject().nquality~=3 then
                        GetCTipsManager():AddMessageTipById(201065)
