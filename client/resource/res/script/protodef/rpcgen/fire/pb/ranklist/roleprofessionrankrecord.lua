...
RoleProfessionRankRecord = {}
RoleProfessionRankRecord.__index = RoleProfessionRankRecord


function RoleProfessionRankRecord:new()
	local self = {}
	setmetatable(self, RoleProfessionRankRecord)
	self.rank = 0
	self.roleid = 0
	self.rolename = "" 
	self.school = 0
...
function RoleProfessionRankRecord:marshal(ostream)
	...
	_os_:marshal_wstring(self.faction)
...
function RoleProfessionRankRecord:unmarshal(_os_)
	...
	self.faction = _os_:unmarshal_wstring(self.faction)
...
return RoleProfessionRankRecord
