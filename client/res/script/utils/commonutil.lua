...
function SetPositionScreenCenter(wnd)
	...
	SetPositionOffset(wnd, size.width*0.5, size.height*0.5+8, 0.5, 0.5) ----新
	--SetPositionOffset(wnd, size.width*0.5, size.height*0.5, 0.5, 0.5) ---旧
end
...
function SetPositionOfWindowWithLabel(wnd)
	...
	--SetPositionOffset(wnd, size.width*0.5-32, size.height*0.5+8, 0.5, 0.5)  --原始边键183000
end

function SetPositionOfWindowWithLabel1(wnd)----强化专用
	local size = CEGUI.System:getSingleton():getGUISheet():getPixelSize()
	SetPositionOffset(wnd, size.width*0.5-0, size.height*0.5+8, 0.5, 0.5)
	--SetPositionOffset(wnd, size.width*0.5-32, size.height*0.5+8, 0.5, 0.5)  --原始边键183000
end

function SetPositionOfWindowWithLabelbp(wnd)----帮派专用
	local size = CEGUI.System:getSingleton():getGUISheet():getPixelSize()
	SetPositionOffset(wnd, size.width*0.5-0, size.height*0.47+8, 0.5, 0.5)
	--SetPositionOffset(wnd, size.width*0.5-32, size.height*0.5+8, 0.5, 0.5)  --原始边键183000
end

function SetPositionOfWindowWithLabelsx(wnd)----界面缩小专用
	local size = CEGUI.System:getSingleton():getGUISheet():getPixelSize()
	SetPositionOffset(wnd, size.width*0.5+6, size.height*0.5+8, 0.5, 0.5)
	--SetPositionOffset(wnd, size.width*0.5-32, size.height*0.5+8, 0.5, 0.5)  --原始边键183000
end
...
------/////////排行榜专用Tree
function SetGroupBtnTreeFirstIcon1(item)----用于排行榜-主按钮
	item:seNormalImage(CEGUI.String("cc25412"), CEGUI.String("c1"))
	item:setHoverImage(CEGUI.String("cc25412"),CEGUI.String("c2"))
	item:setSelectionImage(CEGUI.String("cc25412"),CEGUI.String("c2"))
    item:setOpenImage(CEGUI.String("cc25412"),CEGUI.String("c2"))
end

function SetGroupBtnTreeSecondIcon1(item)----用于排行榜-子按钮
	item:seNormalImage(CEGUI.String("cc25412"), CEGUI.String("c3"))
	item:setHoverImage(CEGUI.String("cc25412"),CEGUI.String("c4"))
    item:setSelectionImage(CEGUI.String("cc25412"), CEGUI.String("c4"))
    item:setOpenImage(CEGUI.String("cc25412"), CEGUI.String("c4"))
end


------/////////任务、便捷-专用Tree
function SetGroupBtnTreeFirstIcon2(item)
    local defaultColor = "ff743a0f"  
    item:seNormalImage(CEGUI.String("ccui"), CEGUI.String("rwc1"))
    item:setHoverImage(CEGUI.String("ccui"),CEGUI.String("rwc2"))
    item:setSelectionImage(CEGUI.String("ccui"),CEGUI.String("rwc2"))
    item:setOpenImage(CEGUI.String("ccui"),CEGUI.String("rwc2"))
    item:setTextColours(CEGUI.ColourRect(CEGUI.PropertyHelper:stringToColour(defaultColor), 
                                        CEGUI.PropertyHelper:stringToColour(defaultColor),
                                        CEGUI.PropertyHelper:stringToColour(defaultColor),
                                        CEGUI.PropertyHelper:stringToColour(defaultColor)))
end

function SetGroupBtnTreeSecondIcon2(item)
    local defaultColor = "ff743a0f" 
    item:seNormalImage(CEGUI.String("ccui"), CEGUI.String("rwc3"))
    item:setHoverImage(CEGUI.String("ccui"),CEGUI.String("rwc4"))
    item:setSelectionImage(CEGUI.String("ccui"), CEGUI.String("rwc4"))
    item:setOpenImage(CEGUI.String("ccui"), CEGUI.String("rwc4"))
    item:setTextColours(CEGUI.ColourRect(CEGUI.PropertyHelper:stringToColour(defaultColor), 
                                        CEGUI.PropertyHelper:stringToColour(defaultColor),
                                        CEGUI.PropertyHelper:stringToColour(defaultColor),
                                        CEGUI.PropertyHelper:stringToColour(defaultColor)))
...
------/////////商会专用Tree
function SetGroupBtnTreeFirstIcon3(item)
    local defaultColor = "ff743a0f"  
    local color = CEGUI.PropertyHelper:stringToColour(defaultColor)
    local colorRect = CEGUI.ColourRect(color, color, color, color)

    item:seNormalImage(CEGUI.String("cc2543"), CEGUI.String("ccbtn1"))
    item:setTextColours(colorRect)  -- 设置颜色

    item:setHoverImage(CEGUI.String("cc2543"),CEGUI.String("ccbtn2"))
    item:setTextColours(colorRect)  -- 重新设置颜色

    item:setSelectionImage(CEGUI.String("cc2543"),CEGUI.String("ccbtn2"))
    item:setTextColours(colorRect)  -- 重新设置颜色

    item:setOpenImage(CEGUI.String("cc2543"),CEGUI.String("ccbtn2"))
    item:setTextColours(colorRect)  -- 重新设置颜色
end

function SetGroupBtnTreeSecondIcon3(item)
    local defaultColor = "ff743a0f"  
    local color = CEGUI.PropertyHelper:stringToColour(defaultColor)
    local colorRect = CEGUI.ColourRect(color, color, color, color)

    item:seNormalImage(CEGUI.String("cc2543"), CEGUI.String("ccbtn3"))
    item:setTextColours(colorRect)  -- 设置颜色

    item:setHoverImage(CEGUI.String("cc2543"),CEGUI.String("ccbtn4"))
    item:setTextColours(colorRect)  -- 重新设置颜色

    item:setSelectionImage(CEGUI.String("cc2543"),CEGUI.String("ccbtn4"))
    item:setTextColours(colorRect)  -- 重新设置颜色

    item:setOpenImage(CEGUI.String("cc2543"),CEGUI.String("ccbtn4"))
    item:setTextColours(colorRect)  -- 重新设置颜色
end
----�µ�tree���ڶ�ȡ���а�
...
function GetPetQualityText(t, unusualid)
    if t == 1 then
        return unusualid == 1 and  require "utils.mhsdutils".get_resstring(7804) or require "utils.mhsdutils".get_resstring(7800)   -- 绮梦野生 or 野生
    elseif t == 2 then 
        return unusualid == 1 and require "utils.mhsdutils".get_resstring(7804) or require "utils.mhsdutils".get_resstring(7801) -- 绮梦宝宝 or 宝宝
    elseif t == 3 then
        return unusualid == 1 and require "utils.mhsdutils".get_resstring(7804) or require "utils.mhsdutils".get_resstring(7802) -- 绮梦变异 or 变异
    elseif t == 4  then
        return unusualid == 1 and require "utils.mhsdutils".get_resstring(7804) or require "utils.mhsdutils".get_resstring(7803) -- 绮梦神兽 or 神兽
    else 
        return "" -- 其他不显示品质
    end
end
...
function GetPetKindImageRes(t, unusualid)
    ...
    local imageName = petImageMap[t] and (petImageMap[t][unusualid] or petImageMap[t].default) or ""
    return "set:pettujianui image:" .. imageName
end

-- SkillBox for Pet
-- @skillBox	CEGUI.SkillBox
-- @petData		stMainPetData
-- @certification 用于显示认证角标
...
if skillconf and skillconf.id ~= -1 then
    ...
    skillBox:SetBackGroundImage(CEGUI.String("ccui"), CEGUI.String(img))
end

	-- corner certification image
	if showCornerImg then
	    if certification and certification == 1 then
		    skillBox:SetCornerImage("ccui", "renzheng")
            return
	    end
	end
    ...
    -- corner bind img
    if showBindImg then
        skillBox:SetCornerImage("ccui", "bangding")
    end
end



function SetPetSkillBoxInfond(skillBox, skillid, petData, showCornerImg, certification, showBindImg)--内丹-摆摊 详情用的
    if skillid == 0 then
        return
    end
    ...
    -- Ccui1
    skillBox:SetBackGroundImage(CEGUI.String("ccui1"), CEGUI.String("petndzbcell")) 
...
----用于绮梦学习技能
function SetPetSkillBoxInfotm(skillBox, skillid, petData, showCornerImg, certification, showBindImg)
    if skillid == 0 then
        return
    end
    ...
    local skillconf = BeanConfigManager.getInstance():GetTableByName("skill.cpetskillconfig"):getRecorder(skillid)
if skillconf and skillconf.id ~= -1 then
    local img = (skillconf.skilltype==1 and "tm" or "tm")
    img = img .. (skillconf.color==1 and 1 or skillconf.color==2 and 2 or skillconf.color==3 and 3 or skillconf.color==4 and 4 or 5)
    skillBox:SetBackGroundImage(CEGUI.String("ccui1"), CEGUI.String(img))
end

	-- corner certification image
	if showCornerImg then
	    if certification and certification == 1 then
		    skillBox:SetCornerImage("ccui1", "tm")
            return
	    end
	end
...
function SetPetItemCellInfo(cell, petData)
	...
	if petData.key == gGetDataManager():GetBattlePetID() then --出战
		cell:SetCornerImageAtPos("ccui", "chongwu_zhan", 1, 0.5)
	end
	if petData.flag == 2 then --绑定
		cell:SetCornerImageAtPos("ccui", "tm", 1, 0.8) 
	end
	...
	if bTreasure then
		cell:SetCornerImageAtPos("ccui1", "newzp", 0, 1)
	end
    if petAttr then
...
function SetPetItemCellInfock(cell, petData)
	if not cell or not petData then
		return
	end
...
function SetPetItemCellInfo4(cell, petData)
	if not cell or not petData then
		return
	end
    ...
    if petAttr then
        SetItemCellBoundColorByQulityPettmdi(cell, petAttr.quality)
    end
end
...
function SetItemCellBoundColorByQulityPet(itemCell, quality)
    local img = (quality == 1 and "lankuang" or
                ...
                "chongwu_di")))))
    itemCell:SetBackGroundImage("ccui", img)
end
...
---宠物头像透明框
function SetItemCellBoundColorByQulityPettmdi(itemCell, quality)---新增加的
	local img = (quality == 1 and "tm" or
                (quality == 2 and "tm" or
                (quality == 3 and "tm" or
                (quality == 4 and "tm" or
                (quality == 5 and "tm" or
                "chongwu_di")))))
    itemCell:SetBackGroundImage("ccui1", img)
end
...
function SetItemCellBoundColorByQulityItemWithId(itemCell,nItemId)
	...
	itemCell:setProperty("BackgroundEnabled", "False")
end
...
-----=========装备打造等=============
function SetItemCellBoundColorByQulityItemWithIddzcell(itemCell,nItemId)
    local nQuality = 0
    local itemTable = BeanConfigManager.getInstance():GetTableByName("item.citemattr"):getRecorder(nItemId)
    if  itemTable then
        nQuality = itemTable.nquality
    end
    SetItemCellBoundColorByQulityItemfbcell(itemCell,nQuality)
	itemCell:setProperty("BackgroundEnabled", "False")
end


function SetItemCellBoundColorByQulityItemdzcell(itemCell, nQuality)
--itemCell:setProperty("BackgroundEnabled", "False") 
    ...
    if nQuality == 0 then
        itemCell:SetBackGroundImage("ccui1", "kuang2")
    elseif nQuality == 1 then
            itemCell:SetBackGroundImage("ccui1", "jmkuang2")
    elseif nQuality == 2 then
        itemCell:SetBackGroundImage("ccui1", "jmkuang2")
    elseif nQuality == 3 then
        itemCell:SetBackGroundImage("ccui1", "jmkuang2")
...
function refreshItemCellBind(itemCell,nBagId,nItemKey)
    ...
    if bBind==true then
        itemCell:SetCornerImageAtPos("ccui", "tm", 1, 0.5,7,7)
    end
end

-------------------------------------------------------------------------
-- Role Type 人物类型: 物攻、法攻、治疗、辅助、控制
-------------------------------------------------------------------------
...
function gCommon.reset()
	...
	gCommon.isCBGChecked = false --藏宝阁验证
end
gCommon.reset()
...
function SetVeticalScrollCellTop(scroll, wnd)
	...
	offset = math.max(0, math.min(docH-pageH, offset-h*0.5)) --在最上面留出半格的空余，表示上面还是其他的行
...
function CheckBagCapacityForItem(itemid, num)
	...
	if itemAttr and itemAttr.maxNum > 1 then --判断是否可以堆叠
		return emptyNum >= 1
	end
	return emptyNum >= num
end
...
function ShowItemTreasureIfNeed(itemcell, itembaseid)
    ...
    if conf and conf.id ~= 1 and conf.treasure == 1 then 
        itemcell:SetCornerImageAtPos("ccui1", "newzp", 0, 1)
    end
end
...
function GetRideEffectId(rideModalId)
	if rideModalId ~= 0 then
        local rideTable = BeanConfigManager.getInstance():GetTableByName("npc.cridea")
