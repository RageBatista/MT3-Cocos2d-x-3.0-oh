...
local click_interval = 1 -- 设定允许的点击间隔（秒）
...
function CCreateRoleDialog.new()
	...
	self.roleSeqNumLast = self.roleSeqNum
    ...
    self.roleback:setVisible(true)
	
	--切换立绘
	self.lihuiQh = winMgr:getWindow("CharacterCreatedDlg/lhqh")
    self.lihuiQh:subscribeEvent("Clicked", CCreateRoleDialog.lihuiQhClicked,self)
    self.lihuiQh:setVisible(true)
	self.lihuiQh2 = winMgr:getWindow("CharacterCreatedDlg/lhqh2")
    self.lihuiQh2:setVisible(false)
    self.lihuiQh2:subscribeEvent("Clicked", CCreateRoleDialog.lihuiQhClicked2,self)
	...
	--初始化人魔仙按钮状态
    self.ren:setProperty("NormalImage", "set:juesecjtouxiang image:renb")
    self.xian:setProperty("NormalImage", "set:juesecjtouxiang image:xiana")
    self.mo:setProperty("NormalImage", "set:juesecjtouxiang image:moa")
    ...
    self.c1:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."11")
    ...
    for i = 0 , SCHOOL_BTN_NUM - 1 do
		...
		--print('i=================%s',i)
		--gGetGameUIManager():AddUIEffect(self.m_pSchoolBtn[i], "geffect/ui/mt_xuanzhong/xuanzhong1", true)  --选中特效
...
--	self.schoolSelectbox:setVisible(false) --默认不选择职业
	...
	--龙骨
    self.roleEffectBg = winMgr:getWindow("CharacterCreatedDlg/Back/roleback/spine")
...
-- 按钮点击事件处理函数
function CCreateRoleDialog:onButtonClicked()
    local current_time = os.time()
    -- 如果上次点击时间与现在的间隔小于设定的点击间隔，则不执行操作
    if current_time - last_click_time < click_interval then
		local strbuilder = StringBuilder:new()
		local tempStrTip = strbuilder:GetString(MHSD_UTILS.get_msgtipstring(201079))
        strbuilder:delete()
...
function CCreateRoleDialog:HandleCaracterRen()
	local dianjijiange= self:onButtonClicked()
	if dianjijiange then 
		self.lastclass = self.class
		self.class = 0
		self.zhongzu = "ren"
...
function CCreateRoleDialog:HandleCaracterXian()
	...
	if dianjijiange then 
		...
		self.class = 1
		self.zhongzu = "xian"
		self.ren:setProperty("NormalImage", "set:juesecjtouxiang image:rena")
		self.xian:setProperty("NormalImage", "set:juesecjtouxiang image:xianb")
		self.mo:setProperty("NormalImage", "set:juesecjtouxiang image:moa")
		self:HandleCaracterClick1()
	end
end
...
function CCreateRoleDialog:HandleCaracterMo()
	...
	if dianjijiange then 
		...
		self.ren:setProperty("NormalImage", "set:juesecjtouxiang image:rena")
		self.xian:setProperty("NormalImage", "set:juesecjtouxiang image:xiana")
		self.mo:setProperty("NormalImage", "set:juesecjtouxiang image:mob")
		self:HandleCaracterClick1()
	end
end

function CCreateRoleDialog:HandleCaracterClick1()
	if self.lastclass == self.class then
		local dianjijiange= self:onButtonClicked()
		if dianjijiange then 
			if not self.class then self.class = 0 end
			self.roleSeqNumLast = self.roleSeqNum
			self.roleSeqNum = self.class * 6 + 1
			if self.zhongzu ~= 'mo' then
				self.c1:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."11")
				self.c2:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."3")
				self.c3:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."5")
				self.c4:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."4")
				self.c5:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."6")
				self.c6:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."2")

				self.c1:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."1")
				self.c2:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."33")
				self.c3:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."55")
				self.c4:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."44")
				self.c5:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."66")
				self.c6:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."22")
			else
				self.c1:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."11")
				self.c2:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."3")
				self.c3:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."5")
				self.c4:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."2")
				self.c5:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."4")
				self.c6:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."6")

				self.c1:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."1")
				self.c2:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."33")
				self.c3:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."55")
				self.c4:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."22")
				self.c5:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."44")
				self.c6:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."66")
			end
...
function CCreateRoleDialog:HandleCaracterClick2()
	...
	if dianjijiange then 
		...
		if self.zhongzu ~= 'mo' then
			self.c1:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."1")
			self.c2:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."33")
			self.c3:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."5")
			self.c4:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."4")
			self.c5:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."6")
			self.c6:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."2")
			
			self.c1:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."11")
			self.c2:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."3")
			self.c3:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."55")
			self.c4:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."44")
			self.c5:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."66")
			self.c6:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."22")
...
function CCreateRoleDialog:HandleCaracterClick3()
	...
	if dianjijiange then 
		...
		if self.zhongzu ~= 'mo' then
			self.c1:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."1")
			self.c2:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."3")
			self.c3:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."55")
			self.c4:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."4")
			self.c5:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."6")
			self.c6:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."2")
			...
			self.c1:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."11")
			self.c2:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."33")
			self.c3:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."5")
			self.c4:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."44")
			self.c5:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."66")
			self.c6:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."22")
		else
...
function CCreateRoleDialog:HandleCaracterClick4()
	...
	if dianjijiange then 
		...
		if self.zhongzu ~= 'mo' then
			...
			self.c2:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."3")
			self.c3:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."5")
			self.c4:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."44")
			self.c5:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."6")
			self.c6:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."2")
			...
			self.c2:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."33")
			self.c3:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."55")
			self.c4:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."4")
			self.c5:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."66")
			self.c6:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."22")
		else
			self.c1:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."1")
			self.c2:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."3")
			self.c3:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."5")
			self.c4:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."22")
			self.c5:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."4")
			self.c6:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."6")
			...
			self.c2:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."33")
			self.c3:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."55")
			self.c4:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."2")
			self.c5:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."44")
			self.c6:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."66")
		end
		self:refreshCurrentRole()
...
function CCreateRoleDialog:HandleCaracterClick5()
	...
	if dianjijiange then 
		...
		if self.zhongzu ~= 'mo' then
			...
			self.c3:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."5")
			self.c4:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."4")
			self.c5:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."66")
			self.c6:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."2")
			...
			self.c3:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."55")
			self.c4:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."44")
			self.c5:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."6")
			self.c6:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."22")
		else
			self.c1:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."1")
			self.c2:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."3")
			self.c3:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."5")
			self.c4:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."2")
			self.c5:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."44")
			self.c6:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."6")
			...
			self.c3:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."55")
			self.c4:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."22")
			self.c5:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."4")
			self.c6:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."66")
		end
		self:refreshCurrentRole()
	end
...
function CCreateRoleDialog:HandleCaracterClick6()
	...
	if dianjijiange then 
		...
		if self.zhongzu ~= 'mo' then
			...
			self.c4:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."4")
			self.c5:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."6")
			self.c6:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."22")
			...
			self.c4:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."44")
			self.c5:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."66")
			self.c6:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."2")
		else
			self.c1:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."1")
			self.c2:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."2")
			self.c3:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."3")
			self.c4:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."4")
			self.c5:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."5")
			self.c6:setProperty("NormalImage", "set:juesecjtouxiang image:"..self.zhongzu.."66")
			...
			self.c4:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."22")
			self.c5:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."44")
			self.c6:setProperty("PushedImage", "set:juesecjtouxiang image:"..self.zhongzu.."6")
		end
		self:refreshCurrentRole()
	end
end
...
function CCreateRoleDialog:SetSchoolSelected(pWnd)
    ...
    if self.selectedSchoolBtnIdx then
        local img = (self.selectedSchoolBtnIdx==0 and config.schoolimg1 or
					...
					(self.selectedSchoolBtnIdx==2 and config.schoolimg3 or
					(self.selectedSchoolBtnIdx==3 and config.schoolimg4 or
					(self.selectedSchoolBtnIdx==4 and config.schoolimg5
					))))) .. "1"
	...
	local diwenimg = (self.selectedSchoolBtnIdx==0 and config.diwenimg1 or
					 ...
					 (self.selectedSchoolBtnIdx==3 and config.diwenimg4 or
					 (self.selectedSchoolBtnIdx==4 and config.diwenimg5 or ""
					 )))))
					 --print(diwenimg)
    ...
    if (self.m_iSelectedSchool ~= config.schools[self.selectedSchoolBtnIdx]) then
		...
		if schoolconf then
           ...
           -- self.enSchoolName:setText(schoolconf.englishName)
			...
			--local str = "<T t='" .. schoolconf.describe .. "' c='FFFA8072'/>"  --改创建角色门派介绍颜色
...
function CCreateRoleDialog:showBackImg()
	...
	self.backImgList[self.roleSeqNum]:setVisible(true)
	if self.roleSeqNumLast ~= self.roleSeqNum then 
		--self.backImgList[self.roleSeqNumLast]:setVisible(false)
		local aniMan = CEGUI.AnimationManager:getSingleton()
		-- self.animationOpen2 = aniMan:getAnimation("createrolebgcs")
		-- self.m_aniopen2 = aniMan:instantiateAnimation(self.animationOpen2)
		-- self.m_aniopen2:setTargetWindow(self.backImgList[self.roleSeqNum])
		-- self.m_aniopen2:unpause()
		
		self.backImgList[self.roleSeqNum]:setPosition(CEGUI.UVector2(CEGUI.UDim(0,0),CEGUI.UDim(0,0)))
		if self.roleSeqNumLast > self.roleSeqNum then
			self.animationOpen1 = aniMan:getAnimation("createrolebglr")
			self.animationOpen = aniMan:getAnimation("createrolebgr")
			--self.animationOpen3 = aniMan:getAnimation("createrolebgl")
		else
			self.animationOpen1 = aniMan:getAnimation("createrolebgll")
			self.animationOpen = aniMan:getAnimation("createrolebgl")
			--self.animationOpen3 = aniMan:getAnimation("createrolebgl")
		end
		self.m_aniopen1 = aniMan:instantiateAnimation(self.animationOpen1)
		self.m_aniopen1:setTargetWindow(self.backImgList[self.roleSeqNumLast])
		self.m_aniopen1:unpause()
		
		self.m_aniopen = aniMan:instantiateAnimation(self.animationOpen)
		self.m_aniopen:setTargetWindow(self.backImgList[self.roleSeqNum])
		self.m_aniopen:unpause()
		
		-- self.m_aniopen2 = aniMan:instantiateAnimation(self.animationOpen3)
		-- self.m_aniopen2:setTargetWindow(self.smokeBg)
		-- self.m_aniopen2:unpause()
...
function CCreateRoleDialog:HandleFinishBtnClicked(e)
    if self.m_bIsClickStart == true then
        GetCTipsManager():AddMessageTipById(162169) -- 正在链接�?
        return true
    end
    ...
    local serverid = gGetLoginManager():getServerID()
	if serverid == 1101961101 then
    local editname1 = self.m_recruitCodeRich:getText()
    if (editname1 ~= "888666") then
        --你还没为你的角色取名呢，快给你的角色取一个响亮的名字吧。
        GetCTipsManager():AddMessageTip(GameTable.message.GetCMessageTipTableInstance():getRecorder(198177).msg,false)
        return true;
    end
	end
	
	--角色名称限定�?-7个汉字，4-14个英文数�?
    ...
    --检查网络连�?
	if self.disconnect then
		gGetMessageManager():AddConfirmBox(eConfirmOK, MHSD_UTILS.get_resstring(1135),	--连接服务器失�?
            MessageManager.HandleDefaultCancelEvent, MessageManager,
            MessageManager.HandleDefaultCancelEvent, MessageManager
        )
        return
...
function CCreateRoleDialog:refreshSchoolIconAndName()
	local visibleBtns = {}
	local conf = BeanConfigManager.getInstance():GetTableByName("role.createroleconfig"):getRecorder(self.roleSeqNum)
	print("self.roleSeqNum====================%s",self.roleSeqNum)
	--PrintTable(conf,3)
	...
	if conf.schools[3] == 0 then
		self.m_pSchoolBtn[3]:setVisible(false)
	else
		table.insert(visibleBtns, self.m_pSchoolBtn[3])
		self.m_pSchoolBtn[3]:setVisible(true)
		self.m_pSchoolBtn[3]:setProperty("NormalImage", conf.schoolimg4 .. "1")
		self.m_pSchoolBtn[3]:setProperty("PushedImage", conf.schoolimg4 .. "1")
	end
	local xpos = 0 - 330
	if self.roleSeqNum == 2 or self.roleSeqNum == 4 or self.roleSeqNum == 6 then
		if conf.schools[4] == 0 then
			self.m_pSchoolBtn[4]:setVisible(false)
		else
			for i = 0 , SCHOOL_BTN_NUM - 1 do
				local y = self.m_pSchoolBtn[i]:getPosition().y.offset
				local x = xpos + 80 * i
				local newXPos = CEGUI.UDim(0, x )
				local newYPos = CEGUI.UDim(0, y )
				self.m_pSchoolBtn[i]:setPosition(CEGUI.UVector2(newXPos, newYPos))
			end
			table.insert(visibleBtns, self.m_pSchoolBtn[4])
			self.m_pSchoolBtn[4]:setVisible(true)
			self.m_pSchoolBtn[4]:setProperty("NormalImage", conf.schoolimg5 .. "1")
			self.m_pSchoolBtn[4]:setProperty("PushedImage", conf.schoolimg5 .. "1")
		end
	else
		for i = 0 , SCHOOL_BTN_NUM - 1 do
			local y = self.m_pSchoolBtn[i]:getPosition().y.offset
...
function CCreateRoleDialog:lihuiQhClicked(args)
	--LogInfo("dianjichengggong")
	-- self.spine:delete()
	-- self.spine = nil
	-- self.spine2:delete()
	-- self.spine2 = nil
	--self.spriteBack:setVisible(false)
	self.lhqeStatus = 2
		if self.spine then
			self.spine:delete()
			self.spine = nil
		...
		self.lihuiQh:setVisible(false)
		self.lihuiQh2:setVisible(true)
		--sprite animation
		self:changeSpriteShape()
end
function CCreateRoleDialog:lihuiQhClicked2(args)
	--LogInfo("dianjichengggong2")
	-- self.spine:delete()
	-- self.spine = nil
	-- self.spine2:delete()
	-- self.spine2 = nil
...
function CCreateRoleDialog.performPostRenderFunctions(id)
	...
	if instance.sprite then
		instance.sprite:RenderUISprite()
	end
    if instance.role1IsOnFront then
        if instance.spine then
		    instance.spine:RenderUISprite()
	    end
	    if instance.spine2 then
		    instance.spine2:RenderUISprite()
	    end
    else
	    if instance.spine2 then
		    instance.spine2:RenderUISprite()
...
function CCreateRoleDialog:createSpineSprite()
    local conf = BeanConfigManager.getInstance():GetTableByName("role.createroleconfig"):getRecorder(self.roleSeqNum)
    local pos = self.roleEffectBg:GetScreenPosOfCenter()
	--local loc = Nuclear.NuclearPoint(500,300)
	local loc = Nuclear.NuclearPoint(pos.x, pos.y)
    -- if conf.effectOnTop ~= "" then
        -- gGetGameUIManager():AddUIEffect(self.roleEffectBg, conf.effectOnTop, true)
    -- end
    gGetGameUIManager():AddUIEffect(self.roleEffectBg, 900, true)

	print(conf.spine)
   -- if not self.spine then
    if self.roleSeqNumLast ~= self.roleSeqNum or not self.spine then
