...
jingmaihecheng_st1 = {}
setmetatable(jingmaihecheng_st1, Dialog)
jingmaihecheng_st1.__index = jingmaihecheng_st1

local _instance
function jingmaihecheng_st1.getInstance()
	if not _instance then
		_instance = jingmaihecheng_st1:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_st1.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_st1:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_st1.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_st1.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_st1.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_st1:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_st1.GetLayoutFileName()
	return "jingmaihecheng_st.layout"
end

function jingmaihecheng_st1:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_st1)
	return self
end

function jingmaihecheng_st1:OnCreate()
...
function jingmaihecheng_st1:OnCreate()
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1st1:subscribeEvent("Clicked", jingmaihecheng_st1.hc1st1, self)
	self.m_hc1st2:subscribeEvent("Clicked", jingmaihecheng_st1.hc1st2, self)
	self.m_hc1st3:subscribeEvent("Clicked", jingmaihecheng_st1.hc1st3, self)
	self.m_hc1st4:subscribeEvent("Clicked", jingmaihecheng_st1.hc1st4, self)
	self.m_hc1st5:subscribeEvent("Clicked", jingmaihecheng_st1.hc1st5, self)
	self.m_hc1st6:subscribeEvent("Clicked", jingmaihecheng_st1.hc1st6, self)
	self.m_hc1st7:subscribeEvent("Clicked", jingmaihecheng_st1.hc1st7, self)
	self.m_hc1st8:subscribeEvent("Clicked", jingmaihecheng_st1.hc1st8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_st1.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1st1 = 8013011
TaskHelper.m_hc1st2 = 8013012
TaskHelper.m_hc1st3 = 8013013
TaskHelper.m_hc1st4 = 8013014
TaskHelper.m_hc1st5 = 8013015
TaskHelper.m_hc1st6 = 8013016
TaskHelper.m_hc1st7 = 8013017
TaskHelper.m_hc1st8 = 8013018

-- function jingmaihecheng_st1:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_st1:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_st1:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_st1:jingmaibeibao(args)
