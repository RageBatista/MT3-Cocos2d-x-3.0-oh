...
jingmaihecheng_lg1 = {}
setmetatable(jingmaihecheng_lg1, Dialog)
jingmaihecheng_lg1.__index = jingmaihecheng_lg1

local _instance
function jingmaihecheng_lg1.getInstance()
	if not _instance then
		_instance = jingmaihecheng_lg1:new()
		_instance:OnCreate()
	end
	return _instance
end

function jingmaihecheng_lg1.getInstanceAndShow()
	if not _instance then
		_instance = jingmaihecheng_lg1:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_lg1.getInstanceNotCreate()
	return _instance
end

function jingmaihecheng_lg1.DestroyDialog()
	if _instance then 
...
function jingmaihecheng_lg1.ToggleOpenClose()
	if not _instance then
		_instance = jingmaihecheng_lg1:new()
		_instance:OnCreate()
	else
...
function jingmaihecheng_lg1.GetLayoutFileName()
	return "jingmaihecheng_lg.layout"
end

function jingmaihecheng_lg1:new()
	local self = {}
	self = Dialog:new()
	setmetatable(self, jingmaihecheng_lg1)
	return self
end

function jingmaihecheng_lg1:OnCreate()
...
function jingmaihecheng_lg1:OnCreate()
	...
	self.m_lgbiaoti3:setVisible(false)
   ...
   -- self.m_pKuaijieBtn:subscribeEvent("Clicked", self.HandleKuaijieBtnClicked, self)
	...
	self.m_hc1lg1:subscribeEvent("Clicked", jingmaihecheng_lg1.hc1lg1, self)
	self.m_hc1lg2:subscribeEvent("Clicked", jingmaihecheng_lg1.hc1lg2, self)
	self.m_hc1lg3:subscribeEvent("Clicked", jingmaihecheng_lg1.hc1lg3, self)
	self.m_hc1lg4:subscribeEvent("Clicked", jingmaihecheng_lg1.hc1lg4, self)
	self.m_hc1lg5:subscribeEvent("Clicked", jingmaihecheng_lg1.hc1lg5, self)
	self.m_hc1lg6:subscribeEvent("Clicked", jingmaihecheng_lg1.hc1lg6, self)
	self.m_hc1lg7:subscribeEvent("Clicked", jingmaihecheng_lg1.hc1lg7, self)
	self.m_hc1lg8:subscribeEvent("Clicked", jingmaihecheng_lg1.hc1lg8, self)
	self.m_jingmaibeibao:subscribeEvent("Clicked", jingmaihecheng_lg1.jingmaibeibao, self)
...
------------------------------------------------------
TaskHelper.m_hc1lg1 = 8015011
TaskHelper.m_hc1lg2 = 8015012
TaskHelper.m_hc1lg3 = 8015013
TaskHelper.m_hc1lg4 = 8015014
TaskHelper.m_hc1lg5 = 8015015
TaskHelper.m_hc1lg6 = 8015016
TaskHelper.m_hc1lg7 = 8015017
TaskHelper.m_hc1lg8 = 8015018

-- function jingmaihecheng_lg1:HandleKuaijieBtnClicked(args)
--     local dlg = require("script.logic.pet.jingmaihecheng").getInstanceAndShow()

-- end

-- function jingmaihecheng_lg1:HandleKuaijieBtnClicked(EventArgs)
...
-- function jingmaihecheng_lg1:HandlePetIconClick(EventArgs)
--     require "logic.pet.petlabel".Show()
--     if CChatOutputDialog:getInstance() then
--         CChatOutputDialog:getInstance():OnClose()
--     end
-- end
function jingmaihecheng_lg1:jingmaibeibao(args)
