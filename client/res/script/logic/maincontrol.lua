...
function MainControl:OnCreate()
  ...
  --  self.m_pSkillBtn = CEGUI.Window.toPushButton(winMgr:getWindow("MainControlDlg/back/skill"))
	self.m_pSkillBtn = winMgr:getWindow("MainControlDlg/back/skill")
	...
	self.m_ccshezhi = CEGUI.Window.toPushButton(winMgr:getWindow("MainControlDlg/back/ccshezhi"))---设置
	self.m_ccshezhi:subscribeEvent("Clicked", MainControl.HandleSystem1BtnClicked, self)----设置	
	
	self.m_cczhuzhan = CEGUI.Window.toPushButton(winMgr:getWindow("MainControlDlg/back/cczhuzhan"))---助战
	self.m_cczhuzhan:subscribeEvent("Clicked", MainControl.HandleXiake1BtnClicked, self)----助战
	
	self.m_ccjineng = CEGUI.Window.toPushButton(winMgr:getWindow("MainControlDlg/back/ccjineng"))---技能
	self.m_ccjineng:subscribeEvent("Clicked", MainControl.HandleSkill1BtnClicked, self)----技能
	
	self.m_zuoqi = CEGUI.Window.toPushButton(winMgr:getWindow("MainControlDlg/back/pack2"))--坐骑
	self.m_zuoqi:subscribeEvent("MouseClick", MainControl.HandlePackBtnClicked2, self)--坐骑
	
	self.m_ccbangpai = CEGUI.Window.toPushButton(winMgr:getWindow("MainControlDlg/back/ccbangpai"))---帮派
	self.m_ccbangpai:subscribeEvent("Clicked", MainControl.HandleFriend1BtnClicked, self)----帮派
	
	self.m_ccfabao = CEGUI.Window.toPushButton(winMgr:getWindow("MainControlDlg/back/ccfabao"))---法宝
	self.m_ccfabao:subscribeEvent("Clicked", MainControl.HandlefabaoBtnClicked, self)----法宝
	
	self.m_ccqiling = CEGUI.Window.toPushButton(winMgr:getWindow("MainControlDlg/back/ccqiling"))---器灵
	self.m_ccqiling:subscribeEvent("Clicked", MainControl.HandleqilingBtnClicked, self)----器灵
	
	self.m_ccqianghua = CEGUI.Window.toPushButton(winMgr:getWindow("MainControlDlg/back/ccqianghua"))---强化
	self.m_ccqianghua:subscribeEvent("Clicked", MainControl.HandleProduct1BtnClicked, self)----强化

	self.m_cczuoqi = CEGUI.Window.toPushButton(winMgr:getWindow("MainControlDlg/back/cczuoqi"))---戒指
	self.m_cczuoqi:subscribeEvent("Clicked", MainControl.HandlezuoqiBtnClicked, self)----戒指
...
function MainControl:HandleXiake1BtnClicked(args)---助战新
...
function MainControl:HandleSkill1BtnClicked(args)--技能新
...
function MainControl:HandlezuoqiBtnClicked(e)--戒指

    require "logic.workshop.workshopaq1".getInstanceAndShow()
end

function MainControl:HandlePackBtnClicked2(args) --打开坐骑
    require "logic.zuoqi.characterzuoqidlg".getInstanceAndShow()
	----require"logic.zuoqi.zuoqity".getInstanceAndShow()  ---坐骑统御
end

function MainControl:HandleFriend1BtnClicked(args)---帮派新
...
function MainControl:HandleSystem1BtnClicked(args)---设置新
...
function MainControl:HandlefabaoBtnClicked(args)----法宝新
	require "logic.workshop.workshopaq".getInstanceAndShow()
end

function MainControl:HandleqilingBtnClicked(args)-----器灵新
   require "logic.workshop.Attunement".getInstanceAndShow()
end

function MainControl:HandleProduct1BtnClicked(args)---强化新
