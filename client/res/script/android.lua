...
function LuaAndroid.startBuy(goodid, goodnum)
	...
	ret, openid    = luaj.callStaticMethod("com.tencent.tmgp.mt3.PlatformTencent", "getopenid", nil, "()Ljava/lang/String;")
	ret, openkey   = luaj.callStaticMethod("com.tencent.tmgp.mt3.PlatformTencent", "getopenkey", nil, "()Ljava/lang/String;")
	ret, pay_token = luaj.callStaticMethod("com.tencent.tmgp.mt3.PlatformTencent", "getpay_token", nil, "()Ljava/lang/String;")
	ret, pf        = luaj.callStaticMethod("com.tencent.tmgp.mt3.PlatformTencent", "getpf", nil, "()Ljava/lang/String;")
	ret, pfkey     = luaj.callStaticMethod("com.tencent.tmgp.mt3.PlatformTencent", "getpfkey", nil, "()Ljava/lang/String;")
	local value = openid .. "#" .. openkey .. "#" .. pay_token .. "#" .. pf .. "#" .. pfkey

	local CConfirmCharge = require "protodef.fire.pb.fushi.cconfirmcharge"
