...
public class HTML5WebView extends WebView {
    ...
    private final Runnable mShowWebViewRunnable = new Runnable() {
		@Override
		public void run() {
			if (!mGoneBecauseHideWebview) {
	...
	try {
		...
		Log.e(LOGTAG, "destroy cleanup failed", e);
	}

	ViewGroup vg = mLayout == null ? null : (ViewGroup) mLayout.getParent();
	if (vg != null) {
	...
	private class MyWebViewClient extends WebViewClient {
		...
		public void onPageStarted(WebView view, String url, Bitmap favicon)
		{
			...
			mHandler.removeCallbacks(mShowWebViewRunnable);
			mHandler.postDelayed(mShowWebViewRunnable, 1000);
		}
