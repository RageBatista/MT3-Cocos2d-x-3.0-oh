...
public class SystemUIUtil {
	...
	public static boolean isWifiEnabled() {
		...
		if (l_contex != null) {
			...
			NetworkInfo l_activeInfo = l_CM == null ? null : l_CM.getActiveNetworkInfo();
			return l_activeInfo != null && l_activeInfo.getState() == NetworkInfo.State.CONNECTED
					&& l_activeInfo.getType() == ConnectivityManager.TYPE_WIFI;
		}
		return false;
	}
