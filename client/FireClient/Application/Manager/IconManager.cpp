...
const CEGUI::Image* IconManager::GetImageByID(int id)  //����ͼƬ��id���ͼƬ
{
...
const CEGUI::Image* IconManager::GetBuffIconByID(int id)	//����buff��id�������ͼ��
{
	return GetImageByID(id);
}

const CEGUI::Image* IconManager::GetItemIconByID(int id)  //���ݵ��ߵ�id�������ͼ��
{
	return GetImageByID(id);

}

const CEGUI::Image* IconManager::GetSkillIconByID(int id)  //���ݼ��ܵ�id�������ͼ��
{
	return GetImageByID(id);
}

const CEGUI::String IconManager::GetItemIconPathByID(int id)    // ���ݵ��ߵ�id�������ͼ��ı�ʶ���� (imgeset+name)
{
...
const CEGUI::String IconManager::GetSkillIconPathByID(int id)   // ���ݼ��ܵ�id�������ͼ��ı�ʶ���� (imgeset+name)
{
	return GetImagePathByID(id);
}

void IconManager::CreateImageSet(const CEGUI::String& name)  //����һ��imageset
{
...
CEGUI::String IconManager::FindImageSetNameByID(int id)  //ͨ��IDѰ�����ڵ�imageset������,����Ҳ�������Ϊ��
{
	...
	if ((id >= 30200 && id < 31000))
	{
		...
		{
			int maxImagesetCount = CEGUI::PropertyHelper::stringToInt(StringCover::to_string(GameTable::common::GetCCommonTableInstance().getRecorder(177).value));
