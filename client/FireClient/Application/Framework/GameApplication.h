...
public:
	...
	const std::string getServerListAddress();
	const std::string getSdkLoginAddress();
	const std::string getSdkRegisterAddress();
	...
	bool IsWindowsExitInProgress() const;
...
private:
	...
	std::string m_SdkLoginAddress;
	std::string m_SdkRegisterAddress;
