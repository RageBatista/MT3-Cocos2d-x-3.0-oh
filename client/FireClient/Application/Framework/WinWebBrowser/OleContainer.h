...
protected:
	...
	void TrackBrowserEventConnection(IConnectionPoint* pConnectionPoint, DWORD dwCookie);
	void ResetBrowserEventConnection();
	// 内部数据
protected:
	long   _refNum;
	...
	IStorage*                   _pStorage;
	IConnectionPoint*           _pEventConnectionPoint;
	DWORD                       _dwEventCookie;
	bool                        _bOleInitialized;
