...
public:
    ...
    virtual cocos2d::Image* getSelectedPhoto(int index)
    {
        return dynamic_cast<cocos2d::Image*>(mSelectedPhotos.objectAtIndex(index));
    }
    ...
    virtual void addSelectedPhoto(Image* pImg)
    {
        if (pImg)
        {
    ...
    void onSelected()
    {
        ...
        {
            ScriptEngineManager::getInstance()->getScriptEngine()->executeGlobalFunction(mOnSelectedCallback.c_str());
        }
    }
    ...
    void onCancel()
    {
        ...
        {
            ScriptEngineManager::getInstance()->getScriptEngine()->executeGlobalFunction(mOnCancelCallback.c_str());
        }
    }
