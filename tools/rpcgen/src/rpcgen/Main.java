...
public class Main {
    ...
    public static boolean isLuaPkg = false;
    ...
    private static void usage() {
        ...
        System.out.println("options: -h|--help  -validateMarshal  -validateUnmarshal  -java|-as|-js|-cxx|-lua|-luapkg  -client  -aio  -overwrite  -inenc=<enc>  -outenc=<enc>");
    }
