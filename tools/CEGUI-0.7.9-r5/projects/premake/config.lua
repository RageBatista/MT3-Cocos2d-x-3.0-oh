...
OGRE_PATHS = { "D:\orge_program\orgebuild", "include/OGRE", "lib" }
OIS_PATHS = { "D:\orge_program\orgebuild", "include/OIS", "lib" }
...
BOOST_PYTHON_PATHS = { "D:\orge_program\boost\boost", "", "lib" }
