...
namespace CEGUI
{
	...
	// MT3: Legacy constructor - ButtonBase requires (type, name) in 0.7.9-r5
Switch::Switch(const String& type) :
    ButtonBase(type, type)
{
}
// MT3: Window::operator= is private in 0.7.9-r5
/*
...
*/
	// MT3: Legacy clone() - depends on operator= which is private in 0.7.9-r5
/*
