...
//    const String ItemTable::EventTableLongPressEnd("TableLongPressEnd");
	...
	void ItemTable::RefreshCellPos(bool bFilterHideCell)
	{
		...
		for (size_t i = 0; i < d_ListCells.size(); i++)
		{
			...
			{
				// ycl ���� Cell λ�õĴ���ͳһ���� SetCellPosByIndex ������
