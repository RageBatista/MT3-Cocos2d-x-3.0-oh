...
size_t RichEditboxTextComponent::GetIndexByWidth(float width)
{
	...
	if (d_text.size()>0)
	{
		 ...
		 if (NULL!=fnt)
		 {
				 ...
				 float selectCharWidth=fnt->getTextExtent(d_text.substr(charIndex,1)); //ѡ����Ǹ��ֵĿ���
				 float FirstToSelectWidth=fnt->getTextExtent(d_text.substr(0,charIndex)); //�ӿ�ʼ��ѡ����Ǹ��ֵĿ���
...
RichEditboxComponent* RichEditboxTextComponent::InsertComponent(size_t offset,RichEditboxComponent* pComponent)   //����true���������µ�component
{
...
bool RichEditboxTextComponent::isOnlySpace() //ֻ��ֻ�п��ַ�
{
...
bool RichEditboxTextComponent::isNumber(utf32 num) //�Ƿ��������ַ�
{
	if (num>=48&&num<=57)
	{
		return true;
...
bool RichEditboxTextComponent::GetFirstEmotionInf(size_t& startIdx, size_t& endIdx,bool& bWaitNum,bool bAcceptEmotion) //�õ���һ�������#��λ�ü������Ӧ���ֵ����һλ��Ӧ��λ��
{
	bWaitNum=false;
	...
	while(curIdx!=String::npos&&(curIdx!=d_text.size()-1))
	{
		...
		if (isNumber(nextChar))
		{
			...
			}else if (endIdx==d_text.size()-1) //��������һ�������ַ���������ҿ���������һλ�����±���Ҳ������
			{
