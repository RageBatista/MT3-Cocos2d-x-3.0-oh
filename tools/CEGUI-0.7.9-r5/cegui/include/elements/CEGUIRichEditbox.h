...
public:
    ...
    \brief
        Constructor
    */
    // MT3: Removed default constructor - WindowRenderer in 0.7.9-r5 requires (const String& name, const String& class_name)
    ...
    */
	...
	// MT3: clone() removed - not available in CEGUI-0.7.9-r5 WindowRenderer
...
protected:
	...
	*************************************************************************/
	...
	Point	downPosition;  // downPosition// µ
...
private:
	...
	*************************************************************************/
	...
	bool    CheckAppendLength(const String& ParseText);//жָȵıǷ.
    ...
    bool d_IsClickSelectLine; //ѡ

    bool d_bTopAfterLoadFont;

	float d_ComponentHeightOffset; //ͼ߶ȼ
	
	bool d_isVertCenterfLineText; //richeditbox Ƿж
public:
	//richeditbox?\u2018??\u03A9\u201D??
    ...
    void GetAllEmotionID(std::vector<int>& emotionIds);//ûеı
	...
	void setTextLineVertCenter(bool b){ d_isVertCenterfLineText = b; }//
