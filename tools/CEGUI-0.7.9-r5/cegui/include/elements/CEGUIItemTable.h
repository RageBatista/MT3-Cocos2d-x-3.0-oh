...
namespace CEGUI
{
    ...
    */
	...
	public:
		...
		void RefreshCellPosAndSize();  // ycl ˢ Cell λúͳߴ
		void CalCellPosByIndex(size_t index, float* pX, float* pY) const;  // 㲢һ Cell λ
		void SetCellPosByIndex(ItemCell* pCell, size_t index);  // ycl  һ Cell λ
