...
public:
	...
	static const int s_iGridPixSize=5; //5*5Ϊһ
	typedef std::map<int,int> AREAINFMAP; //Ϣmap,һΪӵID,ڶΪID
	typedef std::map<int,bool> AREAENABLESTATEMAP; //enablemap
	typedef std::vector<const Image*> DRAWIMAGES;  //ҪͼƬ
	/*************************************************************************
